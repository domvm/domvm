(function(k,g){"object"===typeof exports&&"undefined"!==typeof module?module.exports=g():"function"===typeof define&&define.amd?define(g):k.xr=g()})(this,function(){function k(a,d){return{status:a.status,response:a.response,data:d,xhr:a}}function g(a){for(var d=[],e=arguments.length-1;0<e--;)d[e]=arguments[e+1];for(var c in d)if({}.hasOwnProperty.call(d,c)&&(e=d[c],"object"===typeof e))for(var b in e)({}).hasOwnProperty.call(e,b)&&(a[b]=e[b]);return a}function r(a,d){return(a&&a.promise?a.promise:
n.promise||p.promise)(d)}function f(a){return r(a,function(d,e){var c=g({},p,n,a),b=c.xmlHttpRequest();b.withCredentials=c.withCredentials;c.abort&&a.abort(function(){e(k(b));b.abort()});b.open(c.method,c.params?c.url.split("?")[0]+"?"+q(c.params):c.url,!0);b.addEventListener(l.LOAD,function(){if(200<=b.status&&300>b.status){var a=null;b.responseText&&(a=!0===c.raw?b.responseText:c.load(b.responseText));d(k(b,a))}else e(k(b))});b.addEventListener(l.ABORT,function(){return e(k(b))});b.addEventListener(l.ERROR,
