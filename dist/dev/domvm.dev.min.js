...
(d.raw=f._raw),null!=f._data&&(d.data=f._data),null!=f._flags&&(d.flags=f._flags),null==d.key&&(null!=d.ref?d.key=d.ref:null!=f.id?d.key=f.id:null!=f.name&&(d.key=f.name)));null!=c&&(d.body=c);"svg"===d.tag?setTimeout(function(){null==d.ns&&p("SVG_WRONG_FACTORY",[d])},16):"input"===d.tag&&null==d.key&&p("UNKEYED_INPUT",[d]);return d}function fa(a){var b=a.hooks,c=a.vm;c&&c.hooks&&q("willUnmount",c);b=b&&q("willRemove",a);if(2===(a.flags&2)&&k(a.body))for(c=0;c<a.body.length;c++)fa(a.body[c]);return b}
