...
*/
'use strict';(function(F,p){"object"===typeof exports&&"undefined"!==typeof module?module.exports=p():"function"===typeof define&&define.amd?define(p):F.domvm=p()})(this,function(){function F(a){a=typeof a;return"string"===a||"number"===a}function p(a){return"function"===typeof a}function y(a){for(var b=arguments,c=1;c<b.length;c++)for(var e in b[c])a[e]=b[c][e];return a}function ta(a,b){for(var c=[];b<a.length;b++)c.push(a[b]);return c}function ua(a,b){for(var c in a)if(a[c]!==b[c])return!1;return!0}
...
f=d?e[0]:e,e=d?e.slice(1):[];ga(b,f,e)}}}function O(a,b,c,e){if(c!==e){p(c)&&p(e)&&e.name==c.name&&n("INLINE_HANDLER",[a,e,c]);var d=a.el;k(c)?(null==e||k(e)||n("MISMATCHED_HANDLER",[a,e,c]),null!=e&&U(c,e)||(a=ia(c[0],c.slice(1)),d[b]=a)):(p(c)&&c!==e?(null==e||p(e)||n("MISMATCHED_HANDLER",[a,e,c]),a=ia(c,[])):a=Aa(c),d[b]=a)}}function P(a,b,c,e){var d=a.el;null==c?a.el.removeAttribute(b):null!=a.ns?d.setAttribute(b,c):"class"===b?d.className=c:"id"===b||"boolean"===typeof c||e?d[b]=c:"."===b[0]?
d[b.substr(1)]=c:d.setAttribute(b,c)}function ja(a,b){var c=a.attrs||u,e=b.attrs||u;if(c===e)n("REUSED_ATTRS",[a]);else{for(var d in c){var f=c[d],g=A(a.tag,d),h=g?a.el[d]:e[d];B(f)&&(c[d]=f=G(f,r(a)));f!==h&&("style"===d?da(a,b):"_"===d[0]||(z(d)?O(a,d,f,h):P(a,d,f,g)))}for(d in e)d in c||"_"===d[0]||(b=a,e=d,A(a.tag,d)||z(d)?b.el[e]="":b.el.removeAttribute(e))}}function D(a,b,c,e){if(4===a.type)b=a.model,c=a.key,e=a.opts,a=a.view;else if(a.prototype._isClass)return new a(b,c,e);return new J(a,b,
c,e)}function ka(a){for(var b,c=0;c<a.body.length;c++){b=a.body[c];var e=b.type;3>=e?l(a.el,t(b)):4===e?(b=D(b.view,b.model,b.key,b.opts)._redraw(a,c,!1),l(a.el,t(b.node))):5===e&&(b=b.vm,b._redraw(a,c),l(a.el,b.node.el))}}function t(a,b){if(null==a.el)if(1===a.type){if(!b){b=a.tag;var c=a.ns;b=null!=c?K.createElementNS(c,b):K.createElement(b)}a.el=b;if(null!=a.attrs){b=a.attrs;for(var e in b){var c=b[e],d=A(a.tag,e);B(c)&&(b[e]=c=G(c,r(a)));"style"===e?da(a):"_"===e[0]||(z(e)?O(a,e,c):null!=c&&P(a,
...
b,d)},a,b,e):null}function Ca(a,b,c,e){return la(function(c,f){for(var d=b;d!==f;d=d.nextSibling){b=c=d;for(var h=d.nextSibling;h!==f;h=h.nextSibling)0<e(c,h)&&(c=h);c!==d&&(l(a,c,b),d=c)}},a,b,c)}function Da(a,b){return a._node.idx-b._node.idx}function ma(a,b){var c=a.el,e=a.body,d=b.body;b=e[0];var f=e[e.length-1],g=(d[0]||u).el,d=(d[d.length-1]||u).el,h;a:for(;;){for(;;){if(g){if(null==(h=g._node)){n("FOREIGN_ELEMENT",[g]);g=g.nextSibling;continue}if(h.parent!==a){var k=g.nextSibling;null!=h.vm?
h.vm.unmount(!0):C(c,g);g=k;continue}}if(null==b)break a;else if(null==b.el)l(c,t(b),g),b=e[b.idx+1];else if(b.el===g)b=e[b.idx+1],g=g.nextSibling;else break}for(;;){if(d){if(null==(h=d._node)){n("FOREIGN_ELEMENT",[d]);d=d.previousSibling;continue}if(h.parent!==a){k=d.previousSibling;null!=h.vm?h.vm.unmount(!0):C(c,d);d=k;continue}}if(f===b)break a;else if(null==f.el)k=t(f),l(c,k,d?d.nextSibling:null),f=e[f.idx-1];else if(f.el===d)f=e[f.idx-1],d=d.previousSibling;else break}(k=Ba(c,g,b,d,f))||(k=
Ca(c,g,d,Da));g=k.lftSib;d=k.rgtSib}}function Ea(a,b,c,e){for(;c<b.length;c++){e=b[c];if(4===a.type&&null!=e.vm){var d=e.vm;if(d.view===a.view&&d.key===a.key)return e}if(e.el._node===e&&a.tag===e.tag&&a.type===e.type&&a.vm===e.vm&&(a.key===e.key||null==e.key))return e}return null}function Fa(a,b){a:{a=a.key;var c=0,e=b.length-1;if(2147483647>=e)for(;c<=e;){var d=c+e>>1;if(b[d].key===a){a=d;break a}else b[d].key<a?c=d+1:e=d-1}else for(;c<=e;)if(d=Math.floor((c+e)/2),b[d].key===a){a=d;break a}else b[d].key<
a?c=d+1:e=d-1;a=-1}return-1<a?b[a]:null}function Q(a,b,c){b.hooks&&q("willRecycle",b,a);c=a.el=b.el;var e=b.body,d=a.body;c._node=a;if(2===a.type&&d!==e)c.nodeValue=d;else{null==a.attrs&&null==b.attrs||ja(a,b);var f=k(e),g=k(d);if(f)if(g){var f=a.body,g=f.length,h=1===b.type&&0===(b.flags&1);if(h&&0===g)I(b);else{var p=4===(b.flags&4);p?(d=b.body.slice(),d.sort(Ga),e=Fa):(d=b.body,e=Ea);for(var l,n=0,m=0;m<g;m++){c=f[m];var r=c.type;3>=r?(l=e(c,d,n))&&Q(c,l):4===r?(l=e(c,d,n))?l.vm._update(c.model,
a,m):D(c.view,c.model,c.key,c.opts)._redraw(a,m,!1):5===r&&c.vm._update(c.model,a,m);p||null==l||l.idx!==n||n++}h&&ma(a,b)}}else d!==e&&(null!=d?a.raw?c.innerHTML=d:c.textContent=d:I(b));else g?(I(b),ka(a)):d!==e&&(a.raw?c.innerHTML=d:b.raw?c.textContent=d:c.firstChild?c.firstChild.nodeValue=d:c.textContent=d);b.hooks&&q("didRecycle",b,a)}}function Ga(a,b){return a.key>b.key?1:a.key<b.key?-1:0}function na(a){var b=new v;b.type=2;b.body=a;return b}function x(a,b,c,e){if(5!==a.type&&4!==a.type){a.parent=
b;a.idx=c;a.vm=e;if(null!=a.ref){c=r(a);b=["refs"].concat(a.ref.split("."));for(var d;d=b.shift();)c[d]=0===b.length?a:c=c[d]||{}}if(a.hooks&&a.hooks.willRemove||e&&e.hooks&&e.hooks.willUnmount)for(e=a;e=e.parent;)e.flags|=2;if(k(a.body))for(e=a.body,b=0;b<e.length;b++)c=e[b],!1===c||null==c?e.splice(b--,1):k(c)?(d=b--,e.splice.apply(e,[d,1].concat(c))):(null==c.type&&(e[b]=c=na(""+c)),2===c.type?null==c.body||""===c.body?e.splice(b--,1):0<b&&2===e[b-1].type?(e[b-1].body+=c.body,e.splice(b--,1)):
x(c,a,b,null):x(c,a,b,null));else B(a.body)&&(a.body=G(a.body,r(a)))}}function J(a,b,c,e){var d=this;d.view=a;d.model=b;d.key=null==c?b:c;null!=b&&b===c&&n("AUTOKEYED_VIEW",[d,b]);a.prototype._isClass?(a=d.diff,null!=a&&a!==m.diff&&(d.diff=m.diff.bind(d),d.diff(a))):(a=a.call(d,d,b,c,e),p(a)?d.render=a:(a.diff&&(d.diff(a.diff),delete a.diff),y(d,a)));e&&(d.opts=e,e.hooks&&d.hook(e.hooks),e.diff&&d.diff(e.diff));d._redrawAsync=V(function(a){return d._redraw()});d._updateAsync=V(function(a){return d._update(a)});
(a=d.hooks)&&a.didInit&&a.didInit.call(d,d,b,c,e)}function L(a){if(M.length)for(a=a.node,a&&a.el&&a.el.offsetHeight;a=M.shift();)a[0](a[1],a[2])}function oa(a,b,c,e){var d,f;null==c?null!=b&&b.constructor===Object?d=b:f=b:(d=b,f=c);return za(a,d,f,e)}function R(a,b,c,e){this.view=a;this.model=b;this.key=null==c?b:c;this.opts=e}function S(a){this.vm=a}function pa(a,b){a=a.body;if(k(a))for(var c=0;c<a.length;c++){var e=a[c];null!=e.vm?b.push(e.vm):pa(e,b)}return b}function qa(a,b){a.el=b;b._node=a;
var c=a.attrs;for(f in c){var e=c[f],d=A(a.tag,f);"style"===f||"_"===f[0]||(z(f)?O(a,f,e):null!=e&&d&&P(a,f,e,d))}if(k(a.body)){b=b.firstChild;c=0;var f=a.body[c];do 4===f.type?f=D(f.view,f.model,f.key,f.opts)._redraw(a,c,!1).node:5===f.type&&(f=f.node||f._redraw(a,c,!1).node),qa(f,b);while((b=b.nextSibling)&&(f=a.body[++c]))}}function E(a){a=null==a?"":""+a;for(var b=0,c="";b<a.length;b++)switch(a[b]){case "&":c+="&amp;";break;case "<":c+="&lt;";break;case ">":c+="&gt;";break;default:c+=a[b]}return c}
...
hooks:null,raw:!1,ns:null,el:null,tag:null,attrs:null,body:null,flags:0,_class:null,idx:null,parent:null},H={enabled:!0,verbose:!0,AUTOKEYED_VIEW:function(a,b){return["A view has been auto-keyed by its model's identity. If this model is replaced between redraws, this view will unmount, its internal state and DOM will be destroyed and recreated. Consider providing a fixed key to this view to ensure its persistence & DOM recycling. See https://github.com/leeoniya/domvm#dom-recycling.",a,b]},MODEL_REPLACED:function(a,
b,c){return["A view's model was replaced. The model originally passed to the view closure during init is now stale. You probably want to rely only on the model passed to render() or vm.model.",a,b,c]},UNKEYED_INPUT:function(a){return["Unkeyed <input> detected. Consider adding a name, id, _key, or _ref attr to avoid accidental DOM recycling between different <input> types.",a]},UNMOUNTED_REDRAW:function(a){return["Invoking redraw() of an unmounted (sub)view may result in errors.",a]},INLINE_HANDLER:function(a,
...
new v;b.type=1;b.el=b.key=a;return b},FIXED_BODY:1,DEEP_REMOVE:2,KEYED_LIST:4};m._diff=null;m.diff=function(a){var b=this;if(p(a))var c=a;else{c=a.vals;var e=a.then}var d=c.call(b,b,b.model,b.key,b.opts),f=k(d)?U:ua;b._diff=function(){var a=c.call(b,b,b.model,b.key,b.opts),h=d===a||f(d,a);h||(null!=e&&!1===e.call(b,b,d,a)&&(h=!0),d=a);return h}};sa.patch=function(a){a:{if(null!=a.type){if(null!=this.vm){var b=void 0;break a}x(a,this.parent,this.idx,null);this.parent.body[this.idx]=a;Q(a,this);L(r(a))}else{b=
Object.create(this);b.attrs=y({},this.attrs);a=y(this.attrs,a);if(null!=this._class){var c=a.class;a.class=null!=c&&""!==c?this._class+" "+c:this._class}ja(this,b)}b=void 0}return b};m.events=null;m.emit=function(a){var b=arguments,c=this;do{var e=c.events;if(e=e?e[a]:null){e.apply(null,ta(b,1));break}}while(c=c.parent())};m.on=function(a,b){null==this.events&&(this.events={});if(F(a))this.events[a]=b;else for(a in b=a,b)this.on(a,b[a])};m.body=function(){return pa(this.node,[])};"undefined"!==typeof flyd&&
Z({is:function(a){return flyd.isStream(a)},val:function(a){return a()},sub:function(a,b){return flyd.on(b,a)},unsub:function(a){return a.end(!0)}});w.streamCfg=Z;w.prop=function(a,b,c,e){return function(d,f){void 0!==d&&d!==a&&(a=d,!1!==f&&p(b)&&b.apply(c,e));return a}};m.attach=function(a){null==this.node&&this._redraw(null,null,!1);qa(this.node,a);return this};m.html=function(a){null==this.node&&this._redraw(null,null,!1);return T(this.node,a)};sa.html=function(a){return T(this,a)};var Ha={area:!0,
base:!0,br:!0,col:!0,command:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0};w.DEVMODE=H;return w});
