...
1;b.el=b.key=a;return b},FIXED_BODY:1,DEEP_REMOVE:2,KEYED_LIST:4};p._diff=null;p.diff=function(a){var b=this;if(n(a))var c=a;else{c=a.vals;var e=a.then}var d=c.call(b,b,b.model,b.key,b.opts),f=k(d)?U:ua;b._diff=function(){var a=c.call(b,b,b.model,b.key,b.opts),h=d===a||f(d,a);h||(null!=e&&!1===e.call(b,b,d,a)&&(h=!0),d=a);return h}};sa.patch=function(a){a:{if(null!=a.type){if(null!=this.vm){var b=void 0;break a}x(a,this.parent,this.idx,null);this.parent.body[this.idx]=a;Q(a,this);L(r(a))}else{b=Object.create(this);
