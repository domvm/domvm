...
flexShrink:!0,float:!0,fontWeight:!0,gridColumn:!0,lineHeight:!0,lineClamp:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,transform:!0,transformOrigin:!0,widows:!0,zIndex:!0,zoom:!0},ca={},pa=/\[(\w+)(?:=(\w+))?\]/g,F=[],qa=u.prototype={constructor:u,type:null,vm:null,key:null,ref:null,data:null,hooks:null,raw:!1,ns:null,el:null,tag:null,attrs:null,body:null,flags:0,_class:null,idx:null,parent:null},B=D?document:null,S={onevent:function(){}},r=A.prototype={constructor:A,_isClass:!1,view:null,key:null,
model:null,opts:null,node:null,hooks:null,render:null,parent:function(){return z(this.node.parent)},root:function(){for(var a=this.node;a.parent;)a=a.parent;return a.vm},api:null,refs:null,mount:function(a,b){if(b){for(;a.firstChild;)a.removeChild(a.firstChild);this._redraw(null,null,!1);a.nodeName.toLowerCase()!=this.node.tag?(q(this.node),m(a.parentNode,this.node.el,a),a.parentNode.removeChild(a)):m(a.parentNode,q(this.node,a),a)}else this._redraw(null,null),a&&m(a,this.node.el);a&&C(this);return this},
unmount:function(a){var b=this.node;x(b.el.parentNode,b.el);a||C(this)},redraw:function(a){a?this._redraw():this._redrawAsync();return this},update:function(a,b){b?this._update(a):this._updateAsync(a);return this},_update:function(a,b,c,d){null!=a&&this.model!==a&&(this.hooks&&l("willUpdate",this,a),this.model=a);return this._redraw(b,c,d)},_redraw:function(a,b,c){var d=null==a,e=this.node&&this.node.el&&this.node.el.parentNode,g=this.node;if(e&&null!=this._diff&&this._diff())return g&&a&&(a.body[b]=
g,g.idx=b,g.parent=a),this;e&&this.hooks&&l("willRedraw",this);this.refs=null;var f=this.render.call(this,this,this.model,this.key);!1!==this.key&&(f.key=this.key);this.node=f;a?(v(f,a,b,this),a.body[b]=f):g&&g.parent?(v(f,g.parent,g.idx,this),g.parent.body[g.idx]=f):v(f,null,null,this);!1!==c&&(g?g.tag!==f.tag?(g.vm=f.vm=null,a=g.el.parentNode,b=g.el.nextSibling,x(a,g.el),m(a,q(f),b),g.el=f.el,f.vm=this):I(f,g,d):q(f));e&&this.hooks&&l("didRedraw",this);d&&e&&C(this);return this},_redrawAsync:null,
_updateAsync:null,hook:function(a){this.hooks=this.hooks||w({},this.hooks,a)}};J.prototype={constructor:J,type:4,view:null,model:null,key:null,opts:null};K.prototype={constructor:K,type:5,vm:null};D={config:function(a){w(S,a)},ViewModel:A,VNode:u,createView:H,defineElement:ba,defineSvgElement:function(a,b,c,d){a=ba(a,b,c,d);a.ns="http://www.w3.org/2000/svg";return a},defineText:aa,defineComment:function(a){var b=new u;b.type=3;b.body=a;return b},defineView:function(a,b,c,d){return new J(a,
b,c,d)},injectView:function(a){return new K(a)},injectElement:function(a){var b=new u;b.type=1;b.el=b.key=a;return b},FIXED_BODY:1,DEEP_REMOVE:2,KEYED_LIST:4};r._diff=null;r.diff=function(a){var b=this;if(p(a))var c=a;else var c=a.vals,d=a.then;var e=c.call(b,b,b.model,b.key,b.opts),g=n(e)?L:fa;b._diff=function(){var a=c.call(b,b,b.model,b.key,b.opts),h=g(e,a);h||(null!=d&&!1===d.call(b,b,e,a)&&(h=!0),e=a);return h}};qa.patch=function(a){var b;a:{if(null!=a.type){if(null!=this.vm){b=void 0;break a}v(a,
this.parent,this.idx,null);this.parent.body[this.idx]=a;I(a,this);C(z(a))}else{b=Object.create(this);b.attrs=w({},this.attrs);a=w(this.attrs,a);if(null!=this._class){var c=a.class;a.class=null!=c&&""!=c?this._class+" "+c:this._class}W(this,b)}b=void 0}return b};r.events=null;r.emit=function(a){var b=arguments,c=this;do{var d=c.events;if(d=d?d[a]:null){d.apply(null,ea(b,1));break}}while(c=c.parent())};r.on=function(a,b){null==this.events&&(this.events={});if(y(a))this.events[a]=b;else for(a in b=a,
b)this.on(a,b[a])};r.body=function(){return da(this.node,[])};return D});
