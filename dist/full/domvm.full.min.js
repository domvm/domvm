...
a.type];if(l(d)){var e=d[0];var f=d.slice(1);ra(e,f,a,b,c)}else for(var h in d)a.target.matches(h)&&(f=d[h],l(f)?(e=f[0],f=f.slice(1)):(e=f,f=[]),ra(e,f,a,b,c))}function sa(a,b,c,d){c!==d&&(a=a.el,null==c||Q(c)?a[b]=c:null==d&&(a[b]=La))}function ta(a,b,c,d){var e,f;null==c?q(b)?e=b:f=b:(e=b,f=c);return na(a,e,f,d)}function ua(a,b,c){"."===b[0]&&(b=b.substr(1),c=!0);c?a.el[b]="":"xlink:href"===b?a.el.removeAttributeNS("http://www.w3.org/1999/xlink","href"):a.el.removeAttribute(b)}function va(a,b,
c,d,e){var f=a.el;null==c?!e&&ua(a,b,!1):null!=a.ns?"xlink:href"===b?f.setAttributeNS("http://www.w3.org/1999/xlink","href",c):f.setAttribute(b,c):"class"===b?f.className=c:"id"===b||"boolean"===typeof c||d?f[b]=c:"."===b[0]?f[b.substr(1)]=c:f.setAttribute(b,c)}function X(a,b,c){var d=a.attrs||A,e=b.attrs||A;if(d!==e){for(var f in d){var h=d[f],g=J(a.tag,f),k=g?a.el[f]:e[f];x(h)&&(d[f]=h=R(h,w(a)));if(h!==k)if("style"===f){g=h=void 0;k=a;var l=(k.attrs||A).style,p=b?(b.attrs||A).style:null;if(null==
l||da(l))k.el.style.cssText=l;else{for(g in l){var m=l[g];x(m)&&(m=R(m,w(k)));if(null==p||null!=m&&m!==p[g])k.el.style[g]=pa(g,m)}if(p)for(h in p)null==l[h]&&(k.el.style[h]="")}}else"_"!==f[0]&&(H(f)?sa(a,f,h,k):va(a,f,h,g,c))}for(f in e)f in d||"_"===f[0]||ua(a,f,J(a.tag,f)||H(f))}}function F(a,b,c,d){4===a.type&&(b=a.data,c=a.key,d=a.opts,a=a.view);return new N(a,b,c,d)}function wa(a){for(var b,c=0;c<a.body.length;c++){b=a.body[c];var d=b.type;3>=d?m(a.el,y(b)):4===d?(b=F(b.view,b.data,b.key,b.opts)._redraw(a,
c,!1),m(a.el,y(b.node))):5===d&&(b=b.vm,b._redraw(a,c),m(a.el,b.node.el))}}function y(a,b){if(null==a.el)if(1===a.type){if(!b){b=a.tag;var c=a.ns;b=null!=c?O.createElementNS(c,b):O.createElement(b)}a.el=b;null!=a.attrs&&X(a,A,!0);8===(a.flags&8)&&a.body.body(a);l(a.body)?wa(a):null!=a.body&&""!==a.body&&(a.el.textContent=a.body)}else 2===a.type?a.el=b||O.createTextNode(a.body):3===a.type&&(a.el=b||O.createComment(a.body));a.el._node=a;return a.el}function xa(a,b,c,d){c=c.previousSibling;d=d.nextSibling;
a(c,d);return{lftSib:c?c.nextSibling:b.firstChild,rgtSib:d?d.previousSibling:b.lastChild}}function Ma(a,b,c,d,e){var f=e.idx===c.idx+1,h=f?!1:b._node===e,g=f?!0:d._node===c;return h||g?xa(function(c,e){g&&m(a,d,b);h&&m(a,b,e)},a,b,d):null}function Na(a,b,c,d){return xa(function(c,f){for(var e=b;e!==f;e=e.nextSibling){b=c=e;for(var g=e.nextSibling;g!==f;g=g.nextSibling)0<d(c,g)&&(c=g);c!==e&&(m(a,c,b),e=c)}},a,b,c)}function Oa(a,b){return a._node.idx-b._node.idx}function ya(a,b){var c=a.el,d=a.body,
e=b.body;b=d[0];var f=d[d.length-1],h=(e[0]||A).el;e=(e[e.length-1]||A).el;var g;a:for(;;){for(;;){if(h){if(null==(g=h._node)){h=h.nextSibling;continue}if(g.parent!==a){var k=h.nextSibling;null!=g.vm?g.vm.unmount(!0):E(c,h);h=k;continue}}if(null==b)break a;else if(null==b.el)m(c,y(b),h),b=d[b.idx+1];else if(b.el===h)b=d[b.idx+1],h=h.nextSibling;else break}for(;;){if(e){if(null==(g=e._node)){e=e.previousSibling;continue}if(g.parent!==a){k=e.previousSibling;null!=g.vm?g.vm.unmount(!0):E(c,e);e=k;continue}}if(f===
b)break a;else if(null==f.el)k=y(f),m(c,k,e?e.nextSibling:null),f=d[f.idx-1];else if(f.el===e)f=d[f.idx-1],e=e.previousSibling;else break}(k=Ma(c,h,b,e,f))||(k=Na(c,h,e,Oa));h=k.lftSib;e=k.rgtSib}}function za(a){return a.el._node.parent!==a.parent}function Pa(a,b,c){return b[c]}function Qa(a,b,c){for(;c<b.length;c++){var d=b[c];if(null!=d.vm){if(4===a.type&&d.vm.view===a.view&&d.vm.key===a.key||5===a.type&&d.vm===a.vm)return d}else if(!za(d)&&a.tag===d.tag&&a.type===d.type&&a.key===d.key&&(a.flags&
-2)===(d.flags&-2))return d}return null}function Ra(a,b,c){for(;c<b.length;c++){var d=b[c];if(d.key===a.key)return d}return null}function P(a,b){p(b.hooks,"willRecycle",b,a);var c=a.el=b.el,d=b.body,e=a.body;c._node=a;if(2===a.type&&e!==d)c.nodeValue=e;else{null==a.attrs&&null==b.attrs||X(a,b,!1);var f=l(d),h=l(e),g=8===(a.flags&8);if(f)if(h||g){c=a.body;d=c.length;e=b.body;f=e.length;h=8===(a.flags&8);var k=2===(a.flags&2);g=4===(a.flags&4);var m=!k&&1===a.type,t=!0;k=g?Ra:k||h?Pa:Qa;if(m&&0===d)M(b),
h&&(a.body=[]);else{var A=0,x=!1,B=0;if(h){var y={key:null};var z=Array(d)}for(var u=0;u<d;u++){if(h){var q=!1,v=null;if(t){g&&(y.key=c.key(u));var r=k(y,e,B)}if(null!=r){var w=r.idx;v=c.diff(u,r);if(!0===v){var n=r;n.parent=a;n.idx=u}else q=!0}else q=!0;q&&(n=c.tpl(u),C(n,a,u),n._diff=null!=v?v:c.diff(u),null!=r&&P(n,r));z[u]=n}else if(n=c[u],q=n.type,3>=q){if(r=t&&k(n,e,B))P(n,r),w=r.idx}else 4===q?(r=t&&k(n,e,B))?(r.vm._update(n.data,a,u),w=r.idx):F(n.view,n.data,n.key,n.opts)._redraw(a,u,!1):
5===q&&n.vm._update(n.data,a,u);if(null!=r&&(w===B?(B++,B===f&&d>f&&(r=null,t=!1)):x=!0,100<f&&x&&0===++A%10))for(;B<f&&za(e[B]);)B++}h&&(a.body=z);m&&ya(a,b)}}else e!==d&&(null!=e?c.textContent=e:M(b));else h?(M(b),wa(a)):e!==d&&(c.firstChild?c.firstChild.nodeValue=e:c.textContent=e);p(b.hooks,"didRecycle",b,a)}}function N(a,b,c,d){var e=this;e.view=a;e.data=b;e.key=c;x(b)&&(e._stream=ma(b,e));d&&(e.opts=d,e.config(d));a=q(a)?a:a.call(e,e,b,c,d);Q(a)?e.render=a:(e.render=a.render,e.config(a));e._redrawAsync=
ia(function(a){return e._redraw()});e._updateAsync=ia(function(a){return e._update(a)});e.init&&e.init.call(e,e,e.data,e.key,d)}function Aa(a,b,c,d){null!=c&&(c.body[d]=b,b.idx=d,b.parent=c);return a}function Y(a,b,c,d){this.view=a;this.data=b;this.key=c;this.opts=d}function Z(a){this.vm=a}function Ba(a,b){a=a.body;if(l(a))for(var c=0;c<a.length;c++){var d=a[c];null!=d.vm?b.push(d.vm):Ba(d,b)}return b}function Ca(a){var b=arguments,c=b.length;if(1<c){var d=1;if(q(b[1])){var e=b[1];d=2}d=c===d+1&&
(da(b[d])||l(b[d])||e&&8===(e._flags&8))?b[d]:ea(b,d)}return na(a,e,d)}function Da(a,b){a.el=b;b._node=a;var c=a.attrs;for(f in c){var d=c[f],e=J(a.tag,f);"style"!==f&&"_"!==f[0]&&(H(f)?sa(a,f,d):null!=d&&e&&va(a,f,d,e))}8===(a.flags&8)&&a.body.body(a);if(l(a.body)){b=b.firstChild;c=0;var f=a.body[c];do 4===f.type?f=F(f.view,f.data,f.key,f.opts)._redraw(a,c,!1).node:5===f.type&&(f=f.node||f._redraw(a,c,!1).node),Da(f,b);while((b=b.nextSibling)&&(f=a.body[++c]))}}function G(a){a=null==a?"":""+a;for(var b=
0,c="";b<a.length;b++)switch(a[b]){case "&":c+="&amp;";break;case "<":c+="&lt;";break;case ">":c+="&gt;";break;default:c+=a[b]}return c}function Ea(a){a=null==a?"":""+a;for(var b=0,c="";b<a.length;b++)c+='"'===a[b]?"&quot;":a[b];return c}function Fa(a,b){for(var c="",d=0;d<a.length;d++)c+=aa(a[d],b);return c}function aa(a,b){switch(a.type){case 4:var c=F(a.view,a.data,a.key,a.opts).html(b);break;case 5:c=a.vm.html();break;case 1:if(null!=a.el&&null==a.tag){c=a.el.outerHTML;break}c="<"+a.tag;var d=
...
f,a,b)}}e&&p(this.hooks,"willRedraw",this,this.data);g=this.render.call(this,this,this.data,g,h);if(g===f)return Aa(this,f,a,b);this.refs=null;null!=this.key&&g.key!==this.key&&(g.key=this.key);this.node=g;a?(C(g,a,b,this),a.body[b]=g):f&&f.parent?(C(g,f.parent,f.idx,this),f.parent.body[f.idx]=g):C(g,null,null,this);!1!==c&&(f?f.tag!==g.tag||f.key!==g.key?(f.vm=g.vm=null,a=f.el.parentNode,b=f.el.nextSibling,E(a,f.el),m(a,y(g),b),f.el=g.el,g.vm=this):P(g,f):y(g));e&&p(this.hooks,"didRedraw",this,this.data);
...
ea(arguments,1).concat(c,c.data);do{var d=b.onemit;if(d=d?d[a]:null){d.apply(b,c);break}}while(b=b.parent());ba[a]&&ba[a].apply(b,c)};t.onemit=null;t.body=function(){return Ba(this.node,[])};ca.defineElementSpread=Ca;ca.defineSvgElementSpread=function(){var a=Ca.apply(null,arguments);a.ns="http://www.w3.org/2000/svg";return a};t._stream=null;var Sa={area:!0,base:!0,br:!0,col:!0,command:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0},Ga=".innerHTML";
t.attach=function(a){null==this.node&&this._redraw(null,null,!1);Da(this.node,a);return this};t.html=function(a){null==this.node&&this._redraw(null,null,!1);return aa(this.node,a)};Ha.html=function(a){return aa(this,a)};return ca});
