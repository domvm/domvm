...
h&&(a.body=[]);else{var A=0,x=!1,B=0;if(h)var y={key:null},z=Array(d);for(var u=0;u<d;u++){if(h){var q=!1,v=null;if(t){g&&(y.key=c.key(u));var r=k(y,e,B)}if(null!=r){var w=r.idx;v=c.diff(u,r);if(!0===v){var n=r;n.parent=a;n.idx=u}else q=!0}else q=!0;q&&(n=c.tpl(u),C(n,a,u),n._diff=null!=v?v:c.diff(u),null!=r&&P(n,r));z[u]=n}else if(n=c[u],q=n.type,3>=q){if(r=t&&k(n,e,B))P(n,r),w=r.idx}else 4===q?(r=t&&k(n,e,B))?(r.vm._update(n.data,a,u),w=r.idx):F(n.view,n.data,n.key,n.opts)._redraw(a,u,!1):5===q&&
n.vm._update(n.data,a,u);if(null!=r&&(w===B?(B++,B===f&&d>f&&(r=null,t=!1)):x=!0,100<f&&x&&0===++A%10))for(;B<f&&za(e[B]);)B++}h&&(a.body=z);m&&ya(a,b)}}else e!==d&&(null!=e?c.textContent=e:M(b));else h?(M(b),wa(a)):e!==d&&(c.firstChild?c.firstChild.nodeValue=e:c.textContent=e);p(b.hooks,"didRecycle",b,a)}}function N(a,b,c,d){var e=this;e.view=a;e.data=b;e.key=c;x(b)&&(e._stream=ma(b,e));d&&(e.opts=d,e.config(d));a=q(a)?a:a.call(e,e,b,c,d);Q(a)?e.render=a:(e.render=a.render,e.config(a));e._redrawAsync=
