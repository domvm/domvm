...
b,c]);else return e(b,c)}function K(a){if(S.length)for(a=a.node,a&&a.el&&a.el.offsetHeight;a=S.shift();)a[0](a[1],a[2])}function pa(a){var b=a.hooks,c=a.vm;c=c&&c.hooks&&p("willUnmount",c,c.data);b=b&&p("willRemove",a);if(1===(a.flags&1)&&l(a.body))for(var d=0;d<a.body.length;d++)pa(a.body[d]);return c||b}function T(a,b,c){var d=b._node,e=d.hooks,f=d.vm;if(l(d.body))if(1===(d.flags&1))for(var g=0;g<d.body.length;g++)T(b,d.body[g].el);else U(d);null!=f&&(f.node=null);delete b._node;a.removeChild(b);
e&&p("didRemove",d,null,c);f&&f.hooks&&p("didUnmount",f,f.data,c)}function E(a,b){var c=b._node;if(!c._dead){var d=pa(c);null!=d&&"object"===typeof d&&P(d.then)?(c._dead=!0,d.then(Ga(T,[a,b,!0]))):T(a,b)}}function U(a){a=a.body;for(var b=0;b<a.length;b++){var c=a[b];delete c.el._node;null!=c.vm&&(c.vm.node=null);l(c.body)&&U(c)}}function L(a){var b=a.el;if(0===(a.flags&1))l(a.body)&&U(a),b.textContent=null;else{var c=b.firstChild;do a=c.nextSibling,E(b,c);while(c=a)}}function m(a,b,c){var d=b._node,
...
b=d[0];var f=d[d.length-1],g=(e[0]||A).el;e=(e[e.length-1]||A).el;var h;a:for(;;){for(;;){if(g){if(null==(h=g._node)){g=g.nextSibling;continue}if(h.parent!==a){var k=g.nextSibling;null!=h.vm?h.vm.unmount(!0):E(c,g);g=k;continue}}if(null==b)break a;else if(null==b.el)m(c,y(b),g),b=d[b.idx+1];else if(b.el===g)b=d[b.idx+1],g=g.nextSibling;else break}for(;;){if(e){if(null==(h=e._node)){e=e.previousSibling;continue}if(h.parent!==a){k=e.previousSibling;null!=h.vm?h.vm.unmount(!0):E(c,e);e=k;continue}}if(f===
b)break a;else if(null==f.el)k=y(f),m(c,k,e?e.nextSibling:null),f=d[f.idx-1];else if(f.el===e)f=d[f.idx-1],e=e.previousSibling;else break}(k=Ka(c,g,b,e,f))||(k=La(c,g,e,Ma));g=k.lftSib;e=k.rgtSib}}function ya(a){return a.el._node.parent!==a.parent}function Na(a,b,c){return b[c]}function Oa(a,b,c){for(;c<b.length;c++){var d=b[c];if(null!=d.vm){if(4===a.type&&d.vm.view===a.view&&d.vm.key===a.key||5===a.type&&d.vm===a.vm)return d}else if(!ya(d)&&a.tag===d.tag&&a.type===d.type&&a.key===d.key&&(a.flags&
-2)===(d.flags&-2))return d}return null}function Pa(a,b,c){for(;c<b.length;c++){var d=b[c];if(d.key===a.key)return d}return null}function O(a,b){b.hooks&&p("willRecycle",b,a);var c=a.el=b.el,d=b.body,e=a.body;c._node=a;if(2===a.type&&e!==d)c.nodeValue=e;else{null==a.attrs&&null==b.attrs||W(a,b,!1);var f=l(d),g=l(e),h=8===(a.flags&8);if(f)if(g||h){c=a.body;d=c.length;e=b.body;f=e.length;g=8===(a.flags&8);var k=2===(a.flags&2);h=4===(a.flags&4);var m=!k&&1===a.type,t=!0;k=h?Pa:k||g?Na:Oa;if(m&&0===
d)L(b),g&&(a.body=[]);else{var A=0,x=!1,B=0;if(g){var y={key:null};var z=Array(d)}for(var u=0;u<d;u++){if(g){var q=!1,v=null;if(t){h&&(y.key=c.key(u));var r=k(y,e,B)}if(null!=r){var w=r.idx;v=c.diff(u,r);if(!0===v){var n=r;n.parent=a;n.idx=u}else q=!0}else q=!0;q&&(n=c.tpl(u),C(n,a,u),n._diff=null!=v?v:c.diff(u),null!=r&&O(n,r));z[u]=n}else if(n=c[u],q=n.type,3>=q){if(r=t&&k(n,e,B))O(n,r),w=r.idx}else 4===q?(r=t&&k(n,e,B))?(r.vm._update(n.data,a,u),w=r.idx):F(n.view,n.data,n.key,n.opts)._redraw(a,
u,!1):5===q&&n.vm._update(n.data,a,u);if(null!=r&&(w===B?(B++,B===f&&d>f&&(r=null,t=!1)):x=!0,100<f&&x&&0===++A%10))for(;B<f&&ya(e[B]);)B++}g&&(a.body=z);m&&xa(a,b)}}else e!==d&&(null!=e?a.raw?c.innerHTML=e:c.textContent=e:L(b));else g?(L(b),va(a)):e!==d&&(a.raw?c.innerHTML=e:b.raw?c.textContent=e:c.firstChild?c.firstChild.nodeValue=e:c.textContent=e);b.hooks&&p("didRecycle",b,a)}}function M(a,b,c,d){var e=this;e.view=a;e.data=b;e.key=c;x(b)&&(e._stream=la(b,e));d&&(e.opts=d,e.config(d));a=q(a)?a:
...
a.tag)return c+"/>";c+=">";Qa[a.tag]||(l(a.body)?c+=Ea(a.body,b):8===(a.flags&8)?(a.body.body(a),c+=Ea(a.body,b)):c+=a.raw?a.body:G(a.body),c+="</"+a.tag+">");break;case 2:c=G(a.body);break;case 3:c="\x3c!--"+G(a.body)+"--\x3e"}return c}var t="undefined"!==typeof window,ia=(t?window:{}).requestAnimationFrame,A={},l=Array.isArray,Fa=v.prototype={constructor:v,type:null,vm:null,key:null,ref:null,data:null,hooks:null,raw:!1,ns:null,el:null,tag:null,attrs:null,body:null,flags:0,_class:null,_diff:null,
_dead:!1,idx:null,parent:null},x=function(){return!1},ka=z,R=z,J=z,na={},Ha=/\[(\w+)(?:=(\w+))?\]/g,Ia={animationIterationCount:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridRow:!0,gridColumn:!0,order:!0,lineClamp:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,
...
" "+c:this._class}W(this,b)}b=void 0}return b};t.emit=function(a){var b=this,c=b;c=da(arguments,1).concat(c,c.data);do{var d=b.onemit;if(d=d?d[a]:null){d.apply(b,c);break}}while(b=b.parent());aa[a]&&aa[a].apply(b,c)};t.onemit=null;t.body=function(){return Aa(this.node,[])};ba.defineElementSpread=Ba;ba.defineSvgElementSpread=function(){var a=Ba.apply(null,arguments);a.ns="http://www.w3.org/2000/svg";return a};t._stream=null;var Qa={area:!0,base:!0,br:!0,col:!0,command:!0,embed:!0,hr:!0,img:!0,input:!0,
keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0};t.attach=function(a){null==this.node&&this._redraw(null,null,!1);Ca(this.node,a);return this};t.html=function(a){null==this.node&&this._redraw(null,null,!1);return Z(this.node,a)};Fa.html=function(a){return Z(this,a)};return ba});
