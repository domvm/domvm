...
*/
(function(y,n){"object"===typeof exports&&"undefined"!==typeof module?module.exports=n():"function"===typeof define&&define.amd?define(n):y.domvm=n()})(this,function(){function y(a){a=typeof a;return"string"===a||"number"===a}function n(a){return"function"===typeof a}function E(a){for(var b=arguments,d=1;d<b.length;d++)for(var c in b[d])a[c]=b[d][c];return a}function W(a,b){for(var d=[],c=b;c<a.length;c++)d.push(a[c]);return d}function xa(a,b){for(var d in a)if(a[d]!==b[d])return!1;return!0}function X(a,
b){var d=a.length;if(b.length!=d)return!1;for(var c=0;c<d;c++)if(a[c]!==b[c])return!1;return!0}function Y(a){function b(){d=0;a.apply(c,e)}if(!Z)return a;var d,c,e;return function(){c=this;e=arguments;d||(d=Z(b))}}function ya(a,b,d){return function(){return a.apply(d,b)}}function F(a,b){switch(b){case "value":case "checked":case "selected":case "selectedIndex":return!0}return!1}function aa(a){B=a.is;ba=a.val;ca=a.sub;da=a.unsub}function G(a,b){var d=ca(a,function(a){d&&(null!=b.node&&b.redraw(),da(d))});
return ba(a)}function ea(a,b){var d=(a.attrs||z).style,c=b?(b.attrs||z).style:null;if(null==d||y(d))a.el.style.cssText=d;else{for(var e in d){var f=d[e];B(f)&&(f=G(f,a.vm()));if(null==c||null!=f&&f!==c[e]){var g=a.el.style,h=e,k;k=e;k=isNaN(f)||za[k]?f:f+"px";g[h]=k}}if(c)for(var fa in c)null==d[fa]&&(a.el.style[fa]="")}}function ga(a,b,d,c,e){if(a)e?(a=d.parent,a&&a.el&&a.el.offsetHeight):M.push([b,d,c]);else return b(d,c)}function p(a,b,d,c){var e=b.hooks[a];if(e){var f=0===a.lastIndexOf("did",
...
a[d],e=l(c),f=e?c[0]:c,c=e?c.slice(1):[];ja(b,f,c)}}}function P(a,b,d,c){d!==c&&(a=a.el,l(d)?null!=c&&X(d,c)||(d=ka(d[0],d.slice(1)),a[b]=d):(d=n(d)&&d!=c?ka(d,[]):Ba(d),a[b]=d))}function Q(a,b,d,c){var e=a.el;null==d?a.el.removeAttribute(b):"class"==b?e.className=d:"id"==b||"boolean"==typeof d||c?e[b]=d:"."==b[0]?e[b.substr(1)]=d:e.setAttribute(b,d)}function la(a,b){var d=a.attrs||z,c=b.attrs||z,e=a.tag,f;for(f in d){var g=d[f],h=F(e,f),k=h?a.el[f]:c[f];B(g)&&(d[f]=g=G(g,a.vm()));g!==k&&("style"==
f?ea(a,b):"_"==f[0]||(0===f.lastIndexOf("on",0)?P(a,f,g,k):Q(a,f,g,h)))}for(f in c)f in d||"_"==f[0]||(c=a,g=f,F(e,f)||0===f.lastIndexOf("on",0)?c.el[g]="":c.el.removeAttribute(g))}function H(a,b,d,c){5==a.type&&(b=a.model,d=a.key,c=a.opts,a=a.view);return new D(a,b,d,c)}function I(a,b,d){for(var c,e=0;e<a.length;e++)c=a[e],4==c.type?I(a[e].body,b,d):(c.flatIdx=b.length,c.flatParent=d,b.push(c));return b}function R(a){for(var b=!1,d=0;d<a.body.length;d++){var c=a.body[d],e=c.type;4>=e?t(a.el,v(c)):
5==e?(c=H(c.view,c.model,c.key,c.opts)._redraw(a,d,!1),e=c.node.type,t(a.el,v(c.node))):6==e&&(c=u[c.vmid],c._redraw(a,d),e=c.node.type,t(a.el,c.node.el));4==e&&(b=!0)}return b}function v(a,b){if(null==a.el)if(1==a.type){a.el=b||J.createElement(a.tag);if(null!=a.attrs){var d=a.attrs,c;for(c in d){var e=d[c],f=F(a.tag,c);B(e)&&(d[c]=e=G(e,a.vm()));"style"==c?ea(a):"_"==c[0]||(0===c.lastIndexOf("on",0)?P(a,c,e):null!=e&&Q(a,c,e,f))}}l(a.body)?R(a)&&(a.flatBody=I(a.body,[],a)):null!=a.body&&""!==a.body&&
(a.raw?a.el.innerHTML=a.body:a.el.textContent=a.body)}else 2==a.type?a.el=b||J.createTextNode(a.body):3==a.type?a.el=b||J.createComment(a.body):4==a.type&&(a.el=b||J.createDocumentFragment(),R(a));a.el._node=a;return a.el}function Ca(a,b){return b[a.idx+1]}function Da(a,b){return b[a.idx-1]}function Ea(a,b){return b[a.flatIdx+1]}function Fa(a,b){return b[a.flatIdx-1]}function Ga(a){return a.parent}function Ha(a){return a.flatParent}function Ia(a,b){return a._node.flatIdx-b._node.flatIdx}function ma(a,
...
e.body,g=Ma);for(var k,h=0,t=c.body,r=!1,q=0;q<t.length;q++){var m=t[q],n=m.type;4>=n?(k=g(m,f,h))&&S(m,k):5==n?(m=(k=g(m,f,h))?u[k.vmid]._update(m.model,c,q):H(m.view,m.model,m.key,m.opts)._redraw(c,q,!1),n=m.node.type):6==n&&(m=u[m.vmid]._update(m.model,c,q),n=m.node.type);4==n&&(r=!0);c.list||null==k||k.idx!=h||h++}if(!(c.flags&1))if(1==c.type)r&&(c.flatBody=I(c.body,[],c)),na(c,e,r);else if(4==c.type&&d){for(c=c.parent;1!=c.type;)c=c.parent;e={flatBody:c.flatBody};c.flatBody=I(c.body,[],c);na(c,
...
else B(a.body)&&(a.body=G(a.body,a.vm()))}function D(a,b,d,c){var e=Pa++,f=this;f.api={};f.id=e;f.view=a;f.model=b;f.key=null==d?b:d;a=a.call(f,f,b,d);n(a)?f.render=a:(a.diff&&(f.diff(a.diff),delete a.diff),E(f,a));u[e]=f;c&&(f.opts=c,c.hooks&&f.hook(c.hooks),c.diff&&f.diff(c.diff));f._redrawAsync=Y(function(a){return f._redraw()});f._updateAsync=Y(function(a){return f._update(a)})}function K(a){if(M.length)for(a=a.node,a&&a.el&&a.el.offsetHeight;a=M.shift();)a[0](a[1],a[2])}function qa(a,b,d,c){var e,
f;null==d?null!=b&&b.constructor==Object?e=b:f=b:(e=b,f=d);return N(a,e,f,c)}function T(a,b,d,c){this.view=a;this.model=b;this.key=null==d?b:d;this.opts=c}function ra(a,b,d,c){return new T(a,b,d,c)}function sa(a,b,d,c){var e=arguments.length,f,g,h;1==e?(f="frag",h=a):2==e?(f=a,h=b):3==e&&(f=a,g=b,h=d);e=N(f,g,h,c);e.type=4;return e}function ta(a){var b=new w;b.type=1;b.el=b.key=a;return b}function U(a){this.vmid=a.id}function ua(a){return new U(a)}function Qa(){}function va(a,b){var d=a.body;if(l(d))for(var c=
0;c<d.length;c++){var e=d[c];null!=e.vmid?b.push(u[e.vmid]):va(e,b)}return b}function wa(a,b){a.el=b;b._node=a;var d=a.attrs,c;for(c in d){var e=d[c],f=F(a.tag,c);"style"==c||"_"==c[0]||(0===c.lastIndexOf("on",0)?P(a,c,e):null!=e&&f&&Q(a,c,e,f))}if(l(a.body)){d=b.firstChild;c=0;e=a.body[c];do 5==e.type?e=H(e.view,e.model,e.key,e.opts)._redraw(a,c,!1).node:6==e.type&&(e=e.node||e._redraw(a,c,!1).node),wa(e,d);while((d=d.nextSibling)&&(e=a.body[++c]))}}var V="undefined"!=typeof window,Z=(V?window:{}).requestAnimationFrame,
