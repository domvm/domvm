...
TYPE_TEXT:2,isArr:function(a){return a instanceof Array},isVal:function(a){a=typeof a;return"string"===a||"number"===a},isObj:function(a){return"object"===typeof a&&null!==a&&!n.isArr(a)},isFunc:function(a){return"function"===typeof a},isProm:function(a){return"object"===typeof a&&n.isFunc(a.then)},execAll:function(a,h,m,g,f,w){var c;a&&(n.isArr(a)?a:[a]).forEach(function(a){c=a.call(null,h,m,g,f,w)});return c},tick:function(a,h){!h&&v?v(function(){v(a)}):a()},insertArr:function(a,h,m,g){a.splice.apply(a,
[m,g].concat(h))},isEvProp:function(a){return"on"===a.substr(0,2)},isDynProp:function(a,h){switch(a){case "input":case "textarea":case "select":case "option":switch(h){case "value":case "checked":case "selected":case "selectedIndex":return!0}}},camelDash:function(a){return a.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase()},autoPx:function(a,h){return isNaN(h)||r[a]?h:h+"px"},deepSet:function(a,h,m){h=h.split(".");var g=h.pop();h.forEach(function(g){a[g]||(a[g]={});a=a[g]});a[g]=m},keyedIdx:function(a,
h,m,g,f){for(g=0;g<h.length;g++)if(f=h[g],f.key===a)if(m){if(f.vm&&f.vm.view[0]===m)return g}else return g;return-1},raft:function(a){function h(){m=0;a.apply(g,f)}if(!v)return a;var m,g,f;return function(){g=this;f=arguments;m||(m=v(h))}}};u.utils=n})(domvm);(function(u){function v(b,e){return!1===e?null:null==e&&null!=b?b:k.isVal(e)||k.isObj(e)||k.isArr(e)||k.isFunc(e)?e:null}function r(b,e,x,C,d,D){function p(b,e,d){if(d)b[e]=b[e]||[],b[e].push(d);else for(var a in e)b[a]=b[a]||[],b[a].push(e[a])}function l(b,e,a){d=b;D=e;c.update(a,!1);return q(0,!1)}function q(b,C){if(b){for(var l=c;b--&&l.parent;)l=l.parent;l.redraw(0,!0);return l.vm}(l=c.node)&&a(c,"willRedraw",c);c.refs={};var q=c.render.call(c.api,c,e,x),q=g(q,d,D,c);q.vm=c;c.node=q;var p=k.isVal(x)&&
"^"===x[0]?x.substr(1):k.isVal(q.ref)&&"^"===q.ref[0]?q.ref.substr(1):null;q.key=null!=x?x:q.key;for(var t=d;t;)t.vm&&(c.parent||(c.parent=t.vm),null!==p&&k.deepSet(t.vm.refs,p,q)),t=t.parent;if((p=l)&&(q.type!==l.type||q.tag!==l.tag))var p=null,K=!0,n=l.el.parentNode;f(q,p);d&&(d.body[D]=q);!1!==C&&(l&&h(l),!l&&m||w(q,null,q.el),K&&(n||q.parent.el).insertBefore(q.el,n.childNodes[l.idx]));l&&c.hooks&&k.tick(function(){a(c,"didRedraw",c)},!F.useRaf);return c}var m=!d;k.isArr(b)&&(e=b[1],x=b[2],C=b[3],
b=b[0]);x=v(e,x);var c={api:{},node:null,view:[b,x],model:e,opts:C||{},render:null,update:function(b,d){null==b||x===e&&!k.isVal(x)||(e=c.model=b);return!1!==d?q(0):c},on:function(b,e){p(c.events,b,e)},hook:function(b,e){c.hooks=c.hooks||{};p(c.hooks,b,e)},events:{},hooks:null,redraw:F.useRaf?k.raft(q):q,patch:function(b,e){if(k.isObj(e)){var d={tag:b.tag,el:b.el,ns:b.ns,props:{"class":"class"in e?(null!=b["class"]?b["class"]+" ":"")+e["class"]:b.props["class"],style:"style"in e?e.style:b.props.style}};
