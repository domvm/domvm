...
a,d)},hook:function(a,d){p.hooks=p.hooks||{};C(p.hooks,a,d)},events:{},hooks:null,redraw:I.useRaf?h.raft(f):f,patch:function(a,d){if(h.isObj(d)){var e={tag:a.tag,el:a.el,ns:a.ns,props:{"class":"class"in d?d["class"]:a.props["class"],style:"style"in d?d.style:a.props.style}};m(e,a)}else{var q=a.parent,e=g(k(d,q,a.idx,p),a);q.body[a.idx]=e}},emit:function(a){for(var d=Array.prototype.slice.call(arguments,1),e=p;e;){if(e.events[a]){h.execAll(e.events[a],d);break}e=e.parent}},refs:{},parent:null,mount:function(a,
d){var e=null;d&&(a.textContent="",e=a,a=null);n(p.node,e,null,a);return p},attach:function(a){c(p.node,a);return p},unmount:function(){z(p.hooks,"Unmount",x,[],[p])},moveTo:l,updIdx:function(a){B=a}};D&&D.hooks&&p.hook(D.hooks);h.execAll(G,[p]);p.render=a.call(p.api,p,d,q);return e?l(e,B):f(0)}function c(a,d){a.el=d;d._node=a;for(var q in a.props){var b=a.props[q],e=h.isEvProp(q)?q:"."===q[0]?q.substr(1):null;null!==e&&(d[e]=b)}if(h.isArr(a.body))for(q=0;q<a.body.length;q++)c(a.body[q],d.childNodes[q])}
function b(a,d){h.isArr(a.body)&&(a.body.forEach(function(a,d){a&&(a.vm&&!a.moved?a.vm.unmount():b(a,!0))}),a.body=null);a.vm=null;d&&a.el&&a.el.parentNode&&(a.removed=!0,a.hooks?z(a.hooks,"Remove",v,[a]):v(a))}function v(a){a.el.parentNode.removeChild(a.el);a.el=null}function k(a,d,q,b){var e=a;a={type:null,key:null,ref:null,idx:null,parent:null,moved:!1,removed:!1,hooks:null,tag:null,ns:null,guard:!1,raw:!1,props:null,el:null,hasKeys:!1,body:null};h.isFunc(e)&&(e=e());if(h.isArr(e)&&e.length){a.type=
h.TYPE_ELEM;if(1<e.length){var c=1;h.isObj(e[1])&&(a.props=e[1],c=2);a.body=e.length==c+1?h.isVal(e[c])?e[c]:h.isFunc(e[c])?e[c]():e.slice(c):e.slice(c)}e=e[0];if(/[.#]/.test(e)){if(e=A(e),a.tag=e.tag,c=null!=e["class"],null!=e.id||c){var g=a.props||{};null==g.id&&(g.id=e.id);c&&(g["class"]=e["class"]+(null!=g["class"]?" "+g["class"]:""));a.props=g}}else a.tag=e;if(a.props){var e=a.props,l;for(l in e)h.isEvProp(l)?e[l]=x(e[l],b.opts.evctx||b.model||null,a,b):h.isFunc(e[l])&&("href"==l?(e.onclick=
e[l],e.href=e[l].href):e[l]=e[l]()),h.isDynProp(a.tag,l)&&(e["."+l]=e[l]);if(h.isObj(e.style))for(var f in e.style)l=e.style[f],h.isFunc(l)&&(e.style[f]=l());h.isObj(e._hooks)&&(a.hooks=e._hooks,e._hooks=null);a.key=h.isVal(e._key)?e._key:h.isVal(e._ref)?e._ref:h.isVal(e.id)?e.id:h.isVal(e.name)?e.name:null;e._ref&&(a.ref=e._ref);e._raw&&(a.raw=!0);e._data&&(a.data=e._data);e._guard&&(a.guard=!0);e._ref=e._key=e._raw=e._data=e._guard=null}}else h.isVal(e)&&(a.type=h.TYPE_TEXT,a.body=e);null!==a.ref&&
h.deepSet(b.refs,a.ref,a);a.parent=d;a.idx=q;a.ns=d&&d.ns?d.ns:"svg"===a.tag||"math"===a.tag?a.tag:null;if(h.isArr(a.body))for(d=0,q=a.body.length;d<q;d++){f=a.body[d];e=l=null;g=c=!1;h.isFunc(f)&&(f=f());if(null==f)c=!0;else{var m=h.isArr(f),n=m?!1:h.isObj(f);if(m)f.length?h.isArr(f[0])?g=!0:h.isFunc(f[0])?l=w(f[1],f[2]):(e=k(f,a,d,b),l=e.key):c=!0;else if(n)if(h.isFunc(f.redraw))f.moveTo(a,d),e=f.node,l=f.view[1];else{a.body[d--]=""+f;continue}else""===f?c=!0:0<d&&a.body[d-1].type===h.TYPE_TEXT?
(a.body[d-1].body+=""+f,c=!0):e=k(""+f,a,d,b)}c||g?(g?h.insertArr(a.body,f,d,1):a.body.splice(d,1),q=a.body.length,d--):(null!==l&&(a.hasKeys=!0),a.body[d]=e||f)}return a}function g(a,d){d&&(a.hooks?z(a.hooks,"Recycle",r,[d,a]):r(d,a));if(h.isArr(a.body)){var c=0;a.body.forEach(function(b,e){var f=h.isArr(b);if(d){var m=y(b,a,d,c);if(null!==m){var l=m[0],m=m[1];l===c&&c++;l=d.body[l];l.vm?f?2===m?l.vm.moveTo(a,e,b[1]):1===m&&t(b[0],b[1],b[2],b[3],a,e):b.vm&&2===m&&b.vm===l.vm&&l.vm.moveTo(a,e):a.body[e]=
g(b,l);return}}f?t(b[0],b[1],b[2],b[3],a,e):a.body[e]=g(b)})}return a}function n(a,d,b,c){for(var e=!a.el;b&&b._node.removed;)b=b.nextSibling;e&&a.vm&&a.vm.hooks&&h.execAll(a.vm.hooks.willMount,[a.vm]);if(a.type==h.TYPE_ELEM)if(e&&(a.el=d||(a.ns?J.createElementNS(E[a.ns],a.tag):J.createElement(a.tag)),a.props&&m(a)),h.isArr(a.body)){d=0;for(var g=a.el.firstChild;d<a.body.length;d++)g=n(a.body[d],null,g)}else h.isVal(a.body)&&(a.raw?a.el.innerHTML=a.body:e&&(a.el.textContent=a.body));else a.type==
h.TYPE_TEXT&&e&&(a.el=J.createTextNode(a.body));a.el._node=a;d=a.parent;b!==a.el&&(c||d&&d.el)&&(a.hooks?z(a.hooks,e?"Insert":"Reinsert",f,[a,b,c]):f(a,b,c));e&&a.vm&&a.vm.hooks&&Promise.resolve().then(function(){h.execAll(a.vm.hooks.didMount,[a.vm])});return b!==a.el?b:b.nextSibling}function f(a,d,b){(b||a.parent.el).insertBefore(a.el,d)}function y(a,d,b,c,e){var g=h.isArr(a),f=g?w(a[1],a[2]):a.key,l=b.hasKeys,m=d.hasKeys;b=b.body;d=d.body;if(null!==f&&l)return a=h.indexOfKey(f,b),-1<a?[a,2]:null;
c=c||0;if(c>b.length-1)return null;e=0===e?0:e||b.length-1;for(f=null;c<=e;c++)if(l=b[c],null!==l&&l.el)if(g&&l.vm){if(l.vm.view[0]===a[0]){if(l.vm.view[1]===w(a[1],a[2]))return[c,2];var n=!1;if(I.viewScan)for(var x=0;x<d.length;x++){var p=d[x];if(!p.el&&p.vm&&p.vm.view[0]===l.vm.view[0]&&p.vm.view[1]===l.vm.view[1]){n=!0;break}}n||f||!m||-1!=h.indexOfKey(l.key,d)||(f=[c,1])}}else if(a.type===l.type&&(a.type===h.TYPE_TEXT||null!==a.tag&&a.tag===l.tag)&&(null===l.key||!m||-1==h.indexOfKey(l.key,d)))return[c,
1];return f}function r(a,d){d.el=a.el;a.el=null;if(d.type===h.TYPE_TEXT&&d.body!==a.body)d.el.nodeValue=d.body;else{m(d,a);var b=!h.isArr(d.body),c=!h.isArr(a.body);b&&d.body!==a.body?c&&d.el.firstChild?d.el.firstChild.nodeValue=d.body:d.raw?d.el.innerHTML=d.body:d.el.textContent=d.body:c&&!b&&(d.el.textContent="");a.moved=!0}}function z(a,d,b,c,e,f){if(a){var g=a["will"+d];h.isArr(g)&&(g=g[0]);var l=a["did"+d];h.isArr(l)&&(l=l[0]);a=function(){b.apply(null,c);l&&l.apply(null,f||e||c)};g?(g=g.apply(null,
e||c),h.isProm(g)?g.then(a):a()):a()}else b.apply(null,c)}function A(a){if(a in K)return K[a];var d={tag:null,id:null,"class":null};d.tag=a.replace(/^([\w\-]+)?(?:#([\w\-]+))?((?:\.[\w\-]+)+)?$/,function(a,b,e,c){e&&(d.id=e);c&&(d["class"]=c.replace(/\./g," ").trim());return b||"div"});return K[a]=d}function x(a,d,b,c){return function(e){var b,g=e.target._node,f=null;if(h.isFunc(a))b=a.call(d,e,g,c);else if(h.isArr(a))f=a.slice(1),b=a[0].apply(d,f.concat(e,g,c));else if(h.isObj(a))for(var m in a){var q=
a[m];e.target.matches(m)&&(h.isArr(q)?(f=q.slice(1),b=q[0].apply(d,f.concat(e,g,c))):h.isFunc(q)&&(b=q.call(d,e,g,c)))}!1===b&&(e.preventDefault(),e.stopPropagation());c.opts.hasOwnProperty("watch")&&c.opts.watch.fire({type:"event",vm:c,node:g,event:e,data:f})}}function m(a,d){var b=!d;d=d||{};if(d.props||a.props){var c=d.props||{},e=a.props||{},g=c.style,f=e.style;if(h.isObj(g)||h.isObj(f))F(a.el,a.tag,g||{},f||{},M,N,a.ns,b),c.style=e.style=null;F(a.el,a.tag,c,e,L,H,a.ns,b);f&&(e.style=f)}}function F(a,
...
"class"===d?a.className="":"id"===d||h.isEvProp(d)?a[d]=null:a.removeAttribute(d))}var E={svg:"http://www.w3.org/2000/svg",math:"http://www.w3.org/1998/Math/MathML"},K={},J="undefined"==typeof document?{}:document,I={useRaf:!0,viewScan:!1,useDOM:!1};u.view=t;u.view.config=function(a){I=a};var G=null;u.view.extend=function(a,d){G=!G||d?[]:G;G.push(a)};var h=u.util;return u})(domvm);(function(u){var w=/^(?:img|br|input|col|link|meta|area|base|command|embed|hr|keygen|param|source|track|wbr)$/,t=u.util;u.html=function(c){var b="";switch(c.type){case t.TYPE_ELEM:b+="<"+c.tag;if(c.props){var v=t.isVal(c.props.style)?c.props.style:"",k=t.isObj(c.props.style)?c.props.style:null;if(k)for(var g in k)null!==k[g]&&(v+=t.camelDash(g)+": "+t.autoPx(g,k[g])+"; ");for(g in c.props)t.isEvProp(g)||"."===g[0]||(k=c.props[g],t.isFunc(k)&&(k=k()),t.isObj(k)||(!0===k?b+=" "+g:!1!==k&&null!==k&&
