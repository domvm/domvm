...
d._data=d._diff=null}}else n.isVal(d)?(b.type=n.TYPE_TEXT,b.body=d):n.isElem(d)&&(b.type=n.TYPE_ELEM,b.el=d,b.tag=d.nodeName.toLowerCase());null!==b.ref&&n.deepSet(c.refs,b.ref,b);b.parent=h;b.idx=m;b.ns=h&&h.ns?h.ns:"svg"===b.tag||"math"===b.tag?b.tag:null;a||b.diff||!n.isArr(b.body)||v(b,c);return b}function v(b,h){for(var m=0,c=b.body.length;m<c;m++){var a=b.body[m],d=null,e=null,k=!1,f=!1;n.isFunc(a)&&(a=a());if(null==a)k=!0;else{var p=n.isArr(a),v=p?!1:n.isObj(a);if(p)a.length?"string"==typeof a[0]&&
""!==a[0]?(e=g(a,b,m,h),d=e.key):n.isFunc(a[0])?d=w(a[1],a[2]):f=!0:k=!0;else if(v)if(n.isFunc(a.redraw))a.moveTo(b,m),e=a.node,d=a.view[1];else if(n.isElem(a))e=g(a,b,m,h);else{b.body[m--]=""+a;continue}else""===a?k=!0:0<m&&b.body[m-1].type===n.TYPE_TEXT?(b.body[m-1].body+=""+a,k=!0):e=g(""+a,b,m,h)}k||f?(f?n.insertArr(b.body,a,m,1):b.body.splice(m,1),c=b.body.length,m--):(null!==d&&(b.hasKeys=!0),b.body[m]=e||a)}b.body._init=!0}function y(b,h){if(C(h,b))return h.moved=!0,h.wasSame=!0,h;h&&(f(b,
"willRecycle",h,b),A(h,b),f(b,"didRecycle",h,b));if(n.isArr(b.body)){if(!b.body._init){for(var a=b;!a.vm;)a=a.parent;v(b,a.vm)}var c=0;b.body.forEach(function(a,d){var m=n.isArr(a);if(h){var e=B(a,b,h,c);if(null!==e){var k=e[0],e=e[1];k===c&&c++;k=h.body[k];k.vm?m?2===e?k.vm.moveTo(b,d,a[1]):1===e&&l(a[0],a[1],a[2],a[3],b,d):a.vm&&2===e&&a.vm===k.vm&&k.vm.moveTo(b,d):b.body[d]=y(a,k);return}}m?l(a[0],a[1],a[2],a[3],b,d):b.body[d]=y(a)})}return b}function q(b,h,a,c){for(var e=!b.el;a&&a._node.removed;)a=
a.nextSibling;e&&b.vm&&f(b.vm,"willMount",b.vm);if(b.type==n.TYPE_ELEM)if(e&&(b.el=h||(b.ns?K.createElementNS(P[b.ns],b.tag):K.createElement(b.tag)),b.props&&I(b)),n.isArr(b.body)){h=0;for(var d=b.el.firstChild;h<b.body.length;h++)d=q(b.body[h],null,d)}else n.isVal(b.body)&&(b.raw?b.el.innerHTML=b.body:e&&(b.el.textContent=b.body));else b.type==n.TYPE_TEXT&&e&&(b.el=K.createTextNode(b.body));b.el._node=b;h=b.parent;a!==b.el&&(c||h&&h.el)&&(h=e?"Insert":"Reinsert",f(b,"will"+h,b),(c||b.parent.el).insertBefore(b.el,
a),f(b,"did"+h,b));e&&b.vm&&b.vm.hooks&&!b.moved&&f(b.vm,"didMount",b.vm);return a!==b.el?a:a.nextSibling}function B(b,h,a,c,e){var d=n.isArr(b),k=d?w(b[1],b[2]):b.key,g=a.hasKeys,f=h.hasKeys;a=a.body;h=h.body;if(null!==k&&g)return b=n.keyedIdx(k,a,d?b[0]:null),-1<b?[b,2]:null;c=c||0;if(c>a.length-1)return null;e=0===e?0:e||a.length-1;for(k=null;c<=e;c++)if(g=a[c],null!==g&&g.el)if(d&&g.vm){if(g.vm.view[0]===b[0]){if(g.vm.view[1]===w(b[1],b[2]))return[c,2];!k&&f&&-1==n.keyedIdx(g.key,h,g.vm.view[0])&&
(k=[c,1])}}else if(b.type===g.type&&(b.type===n.TYPE_TEXT||null!==b.tag&&b.tag===g.tag)&&(null===g.key||!f||-1==n.keyedIdx(g.key,h,g.vm?g.vm.view[0]:null)))return[c,1];return k}function C(b,a){if(b&&b.diff&&a.diff&&b.diff[0]===a.diff[0]){var c=b.diff.slice(1).concat(a.diff.slice(1));return!a.diff[0].apply(null,c)}return!1}function A(b,a){if(b.el)if(a.el=b.el,b.el=null,a.el&&(a.el._node=a),a.type===n.TYPE_TEXT&&a.body!==b.body)a.el.nodeValue=a.body;else{I(a,b);var c=!n.isArr(a.body),e=!n.isArr(b.body);
c&&a.body!==b.body?e&&a.el.firstChild?a.el.firstChild.nodeValue=a.body:a.raw?a.el.innerHTML=a.body:a.el.textContent=a.body:e&&!c&&(a.el.textContent="");b.moved=!0}}function e(b){b.removed&&b.vm&&(b.vm.node=null);b.el=b.key=b.ref=b.data=b.diff=b.vm=b.body=b.props=null;b.raw=b.moved=b.wasSame=b.removed=!1;J.push(b)}function k(b,a,c,e){return function(c){var d,k=c.target._node,m=null;if(n.isFunc(b))d=b.call(a,c,k,e);else if(n.isArr(b))m=b.slice(1),d=b[0].apply(a,m.concat(c,k,e));else if(n.isObj(b))for(var g in b){var f=
b[g];null!=f&&"_"!=g[0]&&c.target.matches(g)&&(n.isArr(f)?(m=f.slice(1),d=f[0].apply(a,m.concat(c,k,e))):n.isFunc(f)&&(d=f.call(a,c,k,e)))}!1===d&&(c.preventDefault(),c.stopPropagation());e.opts.hasOwnProperty("watch")&&e.opts.watch.fire({type:"event",vm:e,node:k,event:c,data:m})}}function I(b,a){var c=!a;a=a||{};if(a.props||b.props){var e=a.props||{},k=b.props||{},d=e.style,g=k.style;if(n.isObj(d)||n.isObj(g))N(b.el,b.tag,d||{},g||{},x,Q,b.ns,c,b),e.style=k.style=null;N(b.el,b.tag,e,k,L,E,b.ns,c,
b);g&&(k.style=g)}}function N(b,a,c,e,k,d,g,f,p){for(var v in e)if(a=e[v],null!==a){var l="."===v[0]?b[v.substr(1)]:c[v];a===l||n.isArr(a)&&n.isArr(l)&&n.cmpArr(a,l)||k(b,v,a,g,f,p)}for(v in c)null!==c[v]&&null==e[v]&&d(b,v,g,f)}function x(b,a,c){b.style[a]=n.autoPx(a,c)}function Q(b,a){b.style[a]=""}function L(b,a,c,e,g,d){if("."===a[0])a=a.substr(1),"svg"===e?b[a].baseVal=c:b[a]=c;else if("class"===a)b.className=c;else if("id"===a)b[a]=c;else if(n.isEvProp(a)){for(e=d;!e.vm;)e=e.parent;b[a]=k(c,
e.vm.opts.evctx||e.vm.model||null,d,e.vm)}else!1===c?E(b,a,e,g):b.setAttribute(a,!0===c?"":c)}function E(b,a,c,e){e||("."===a[0]?(a=a.substr(1),"svg"===c?b[a].baseVal=null:b[a]=null):"class"===a?b.className="":"id"===a||n.isEvProp(a)?b[a]=null:b.removeAttribute(a))}var P={svg:"http://www.w3.org/2000/svg",math:"http://www.w3.org/1998/Math/MathML"},K="undefined"==typeof document?{}:document,M={},J=[],H=[],G={debounce:!0,repaint:!0};u.view=l;u.view.config=function(b){for(var a in b)G[a]=b[a]};var F=
null;u.view.extend=function(b,a){F=!F||a?[]:F;F.push(b)};var n=u.utils;return u})(domvm);(function(u){var t=/^(?:img|br|input|col|link|meta|area|base|command|embed|hr|keygen|param|source|track|wbr)$/,w=u.utils;u.html=function(l){var a="";switch(l.type){case w.TYPE_ELEM:a+="<"+l.tag;if(l.props){var f=w.isVal(l.props.style)?l.props.style:"",p=w.isObj(l.props.style)?l.props.style:null;if(p)for(var c in p)null!==p[c]&&(f+=w.camelDash(c)+": "+w.autoPx(c,p[c])+"; ");for(c in l.props)w.isEvProp(c)||"."===c[0]||(p=l.props[c],w.isFunc(p)&&(p=p()),w.isObj(p)||(!0===p?a+=" "+c:!1!==p&&null!==p&&
