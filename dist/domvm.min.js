...
h[c])})}}function M(a,b){b.el=a.el;a.el=null;if(2===b.type)b.el.nodeValue=b.body;else{D(b,a);var c=!f(b.body),d=!f(a.body);if(c&&b.body!==a.body)d&&b.el.firstChild?b.el.firstChild.nodeValue=b.body:b.el.textContent=b.body;else if(d&&!c)for(;b.el.firstChild;)b.el.removeChild(b.el.firstChild)}}function D(a,b){var c=!b;b=b||{};if(b.props||a.props){var d=b.props||{},e=a.props||{},g=d.style,f=e.style;if(k(g)||k(f))E(a.el,g||{},f||{},N,O,a.svg,c),d.style=e.style=null;E(a.el,d,e,P,F,a.svg,c);f&&(e.style=
f)}}function E(a,b,c,d,e,f,k){f=f||!1;for(var h in c)null!==c[h]&&(h in b&&c[h]===b[h]||d(a,h,c[h],f,k));for(h in b)null!==b[h]&&(h in c||e(a,h,f,k))}function N(a,b,c){a.style[b]=c}function O(a,b){a.style[b]=""}function P(a,b,c,d,e){"."===b[0]?a[b.substr(1)]=c:"class"===b?a.className=c:"id"===b||0===b.indexOf("on")?a[b]=c:!1===c?F(a,b,d,e):(!0===c&&(c=""),d?a.setAttributeNS(null,b,c):a.setAttribute(b,c))}function F(a,b,c,d){d||("."===b[0]?a[b.substr(1)]=null:"class"===b?a.className="":0===b.indexOf("on")?
a[b]=null:c?a.removeAttributeNS(null,b):a.removeAttribute(b))}var H=/^(?:img|br|input|col|link|meta|area|base|command|embed|hr|keygen|param|source|track|wbr)$/,p={},w="undefined"==typeof window?{}:window,v=document;u.useRaf=!0;return u});
