...
function b(a,d){g.isArr(a.body)&&(a.body.forEach(function(a,d){a&&(a.vm&&!a.moved?a.vm.unmount():b(a,!0))}),a.body=null);a.vm=null;d&&a.el&&a.el.parentNode&&(a.removed=!0,z(a.hooks,"Remove",x,[a]))}function x(a){a.el.parentNode.removeChild(a.el);a.el=null}function k(a,d,p,A){var e=a;a={type:null,key:null,ref:null,idx:null,parent:null,moved:!1,removed:!1,hooks:null,tag:null,ns:null,guard:!1,raw:!1,props:null,el:null,hasKeys:!1,body:null};g.isFunc(e)&&(e=e());if(g.isArr(e)&&e.length){a.type=g.TYPE_ELEM;
if(1<e.length){var b=1;g.isObj(e[1])&&(a.props=e[1],b=2);a.body=e.length==b+1?g.isVal(e[b])?e[b]:g.isFunc(e[b])?e[b]():e.slice(b):e.slice(b)}e=e[0];if(/[.#]/.test(e)){if(e=H(e),a.tag=e.tag,b=null!=e["class"],null!=e.id||b){var c=a.props||{};null==c.id&&(c.id=e.id);b&&(c["class"]=e["class"]+(null!=c["class"]?" "+c["class"]:""));a.props=c}}else a.tag=e;if(a.props){var e=a.props,h;for(h in e)g.isEvProp(h)?e[h]=u(e[h],A.opts.evctx||A.model||null,a,A):g.isFunc(e[h])&&("href"==h?(e.onclick=e[h],e.href=
e[h].href):e[h]=e[h]()),g.isDynProp(a.tag,h)&&(e["."+h]=e[h]);if(g.isObj(e.style))for(var f in e.style)h=e.style[f],g.isFunc(h)&&(e.style[f]=h());g.isObj(e._hooks)&&(a.hooks=e._hooks,e._hooks=null);a.key=g.isVal(e._key)?e._key:g.isVal(e._ref)?e._ref:g.isVal(e.id)?e.id:g.isVal(e.name)?e.name:null;e._ref&&(a.ref=e._ref);e._raw&&(a.raw=!0);e._data&&(a.data=e._data);e._guard&&(a.guard=!0);e._ref=e._key=e._raw=e._data=e._guard=null}}else g.isVal(e)&&(a.type=g.TYPE_TEXT,a.body=e);null!==a.ref&&(A.refs[a.ref]=
a);a.parent=d;a.idx=p;a.ns=d&&d.ns?d.ns:"svg"===a.tag||"math"===a.tag?a.tag:null;if(g.isArr(a.body))for(d=0,p=a.body.length;d<p;d++){f=a.body[d];e=h=null;c=b=!1;g.isFunc(f)&&(f=f());if(null==f)b=!0;else{var m=g.isArr(f),l=m?!1:g.isObj(f);if(m)f.length?g.isArr(f[0])?c=!0:g.isFunc(f[0])?h=w(f[1],f[2]):(e=k(f,a,d,A),h=e.key):b=!0;else if(l)if(g.isFunc(f.redraw))f.moveTo(a,d),e=f.node,h=f.view[1];else{a.body[d--]=""+f;continue}else""===f?b=!0:0<d&&a.body[d-1].type===g.TYPE_TEXT?(a.body[d-1].body+=""+
f,b=!0):e=k(""+f,a,d,A)}b||c?(c?g.insertArr(a.body,f,d,1):a.body.splice(d,1),p=a.body.length,d--):(null!==h&&(a.hasKeys=!0),a.body[d]=e||f)}return a}function f(a,d){d&&z(a.hooks,"Recycle",q,[d,a]);if(g.isArr(a.body)){var b=0;a.body.forEach(function(c,e){var m=g.isArr(c);if(d){var u=l(c,a,d,b);if(null!==u){var h=u[0],u=u[1];h===b&&b++;h=d.body[h];h.vm?m?2===u?h.vm.moveTo(a,e,c[1]):1===u&&r(c[0],c[1],c[2],c[3],a,e):c.vm&&2===u&&c.vm===h.vm&&h.vm.moveTo(a,e):a.body[e]=f(c,h);return}}m?r(c[0],c[1],c[2],
c[3],a,e):a.body[e]=f(c)})}return a}function y(a,d,c,b){for(var e=!a.el;c&&c._node.removed;)c=c.nextSibling;e&&a.vm&&a.vm.hooks&&g.execAll(a.vm.hooks.willMount,[a.vm]);if(a.type==g.TYPE_ELEM)if(e&&(a.el=d||(a.ns?K.createElementNS(E[a.ns],a.tag):K.createElement(a.tag)),a.props&&m(a)),g.isArr(a.body)){d=0;for(var f=a.el.firstChild;d<a.body.length;d++)f=y(a.body[d],null,f)}else g.isVal(a.body)&&(a.raw?a.el.innerHTML=a.body:e&&(a.el.textContent=a.body));else a.type==g.TYPE_TEXT&&e&&(a.el=K.createTextNode(a.body));
a.el._node=a;d=a.parent;c!==a.el&&(b||d&&d.el)&&z(a.hooks,e?"Insert":"Reinsert",t,[a,c,b]);e&&a.vm&&a.vm.hooks&&Promise.resolve().then(function(){g.execAll(a.vm.hooks.didMount,[a.vm])});return c!==a.el?c:c.nextSibling}function t(a,d,c){(c||a.parent.el).insertBefore(a.el,d)}function l(a,d,c,b,e){var f=g.isArr(a),m=f?w(a[1],a[2]):a.key,h=c.hasKeys,u=d.hasKeys;c=c.body;d=d.body;if(null!==m&&h)return a=g.indexOfKey(m,c),-1<a?[a,2]:null;b=b||0;if(b>c.length-1)return null;e=0===e?0:e||c.length-1;for(m=
null;b<=e;b++)if(h=c[b],null!==h&&h.el)if(f&&h.vm){if(h.vm.view[0]===a[0]){if(h.vm.view[1]===w(a[1],a[2]))return[b,2];var l=!1;if(J.viewScan)for(var y=0;y<d.length;y++){var n=d[y];if(!n.el&&n.vm&&n.vm.view[0]===h.vm.view[0]&&n.vm.view[1]===h.vm.view[1]){l=!0;break}}l||m||!u||-1!=g.indexOfKey(h.key,d)||(m=[b,1])}}else if(a.type===h.type&&(a.type===g.TYPE_TEXT||null!==a.tag&&a.tag===h.tag)&&(null===h.key||!u||-1==g.indexOfKey(h.key,d)))return[b,1];return m}function q(a,d){d.el=a.el;a.el=null;if(d.type===
g.TYPE_TEXT&&d.body!==a.body)d.el.nodeValue=d.body;else{m(d,a);var c=!g.isArr(d.body),b=!g.isArr(a.body);c&&d.body!==a.body?b&&d.el.firstChild?d.el.firstChild.nodeValue=d.body:d.raw?d.el.innerHTML=d.body:d.el.textContent=d.body:b&&!c&&(d.el.textContent="");a.moved=!0}}function z(a,d,c,b,e,f){if(a){var m=a["will"+d];g.isArr(m)&&(m=m[0]);var h=a["did"+d];g.isArr(h)&&(h=h[0]);a=function(){c.apply(null,b);h&&h.apply(null,f||e||b)};m?(m=m.apply(null,e||b),g.isProm(m)?m.then(a):a()):a()}else c.apply(null,
b)}function H(a){if(a in L)return L[a];var d={tag:null,id:null,"class":null};d.tag=a.replace(/^([\w\-]+)?(?:#([\w\-]+))?((?:\.[\w\-]+)+)?$/,function(a,c,e,b){e&&(d.id=e);b&&(d["class"]=b.replace(/\./g," ").trim());return c||"div"});return L[a]=d}function u(a,d,c,b){return function(e){var c,f=e.target._node,h=null;if(g.isFunc(a))c=a.call(d,e,f,b);else if(g.isArr(a))h=a.slice(1),c=a[0].apply(d,h.concat(e,f,b));else if(g.isObj(a))for(var m in a){var p=a[m];e.target.matches(m)&&(g.isArr(p)?(h=p.slice(1),
c=p[0].apply(d,h.concat(e,f,b))):g.isFunc(p)&&(c=p.call(d,e,f,b)))}!1===c&&(e.preventDefault(),e.stopPropagation());b.opts.hasOwnProperty("watch")&&b.opts.watch.fire({type:"event",vm:b,node:f,event:e,data:h})}}function m(a,d){var c=!d;d=d||{};if(d.props||a.props){var b=d.props||{},e=a.props||{},f=b.style,m=e.style;if(g.isObj(f)||g.isObj(m))F(a.el,a.tag,f||{},m||{},M,N,a.ns,c),b.style=e.style=null;F(a.el,a.tag,b,e,O,I,a.ns,c);m&&(e.style=m)}}function F(a,d,c,b,e,f,m,h){for(var g in b)null!==b[g]&&
("."===g[0]?a[g.substr(1)]!==b[g]:b[g]!==c[g])&&e(a,g,b[g],m,h);for(g in c)null!==c[g]&&null==b[g]&&f(a,g,m,h)}function M(a,d,b){a.style[d]=g.autoPx(d,b)}function N(a,d){a.style[d]=""}function O(a,d,b,c,e){"."===d[0]?(d=d.substr(1),"svg"===c?a[d].baseVal=b:a[d]=b):"class"===d?a.className=b:"id"===d||g.isEvProp(d)?a[d]=b:!1===b?I(a,d,c,e):a.setAttribute(d,!0===b?"":b)}function I(a,d,b,c){c||("."===d[0]?(d=d.substr(1),"svg"===b?a[d].baseVal=null:a[d]=null):"class"===d?a.className="":"id"===d||g.isEvProp(d)?
a[d]=null:a.removeAttribute(d))}var E={svg:"http://www.w3.org/2000/svg",math:"http://www.w3.org/1998/Math/MathML"},L={},K="undefined"==typeof document?{}:document,J={useRaf:!0,viewScan:!1,useDOM:!1};v.view=r;v.view.config=function(a){J=a};var G=null;v.view.extend=function(a,d){G=!G||d?[]:G;G.push(a)};var g=v.util;return v})(domvm);(function(v){var w=/^(?:img|br|input|col|link|meta|area|base|command|embed|hr|keygen|param|source|track|wbr)$/,r=v.util;v.html=function(c){var b="";switch(c.type){case r.TYPE_ELEM:b+="<"+c.tag;if(c.props){var x=r.isVal(c.props.style)?c.props.style:"",k=r.isObj(c.props.style)?c.props.style:null;if(k)for(var f in k)null!==k[f]&&(x+=r.camelDash(f)+": "+r.autoPx(f,k[f])+"; ");for(f in c.props)r.isEvProp(f)||"."===f[0]||(k=c.props[f],r.isFunc(k)&&(k=k()),r.isObj(k)||(!0===k?b+=" "+f:!1!==k&&null!==k&&
