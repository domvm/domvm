...
attach:e}}function e(a){z(l,a);return d()}function g(){return y(l)}function f(a){r(l);a.appendChild(l.el);return d()}function h(a){var b=null,d=a.split(":");2==d.length&&(a=d[0],b=+d[1]);var d=Array.prototype.slice.call(arguments,1),c=l;if(null!==b){for(;--b&&c.parent;)c=c.parent;c.onEmit[a].apply(null,d)}else for(;c&&!(c.onEmit&&a in c.onEmit&&!1===c.onEmit[a].apply(null,d));)c=c.parent}function t(){var e=q.apply(null,0==arguments.length?b||[]:arguments),e=A(e,!0,c||null);e.name=e.name||a.name||
null;e.onEmit=n.on||{};e.onEmit._redraw=t;l&&B(l,e)&&C(l,e,!0);if(c){var g=c.body.indexOf(l);c.body[g]=e}l=e;setTimeout(function(){x(l,k,!0);p&&p()},0);return d()}var k={};h.event=function(){var a=arguments;return function(){h.apply(null,a)}};h.redraw=function(a){a=a||1E3;return function(){h("_redraw:"+a)}};var m=u.useRaf?G(t):t,n=a(m,k,h),q=n.render,p=n.after,l=null;t();return d()}function A(a,b,c,d){if(m(a))return q(a,null,c).branch;if(f(a)&&m(a[0]))return q(a[0],a.slice(1),c).branch;a=J(a,d);d=
d||a.svg;b&&(a.parent=c||null,c=a);if(f(a.body)){var e={},g=!1;a.body=a.body.map(function(a,b){var f=A(a,!1,c,d);null!==f.key&&(e[f.key]=b,g=!0);return f});g&&(a.keyMap=e)}return a}function K(a){if(a in p)return p[a];var b={tag:null,id:null,class:null};b.tag=a.replace(/^([\w\-]+)?(?:#([\w\-]+))?((?:\.[\w\-]+)+)?$/,function(a,d,e,g){e&&(b.id=e);g&&(b.class=g.replace(/\./g," ").trim());return d||"div"});return p[a]=b}function J(a,b){var c={type:null,name:null,key:null,ref:null,tag:null,svg:!1,guard:!1,
dataset:null,props:null,on:null,onEmit:null,el:null,keyMap:null,body:null};if(f(a)&&a.length){c.type=1;switch(a.length){case 2:f(a[1])?c.body=a[1]:k(a[1])?c.props=a[1]:c.body=a[1];break;case 3:c.props=a[1];c.body=a[2];break}var d=a[0];if(/[.#]/.test(d)){if(d=K(d),c.tag=d.tag,d.id||d.class)c.props=c.props||{},c.props.id=d.id,c.props.class=d.class}else c.tag=d;if(c.props){var d=c.props,e;for(e in d)m(d[e])&&-1==e.indexOf("on")&&(d[e]=d[e]());if(k(d.style))for(var g in d.style)e=d.style[g],m(e)&&(d.style[g]=
e());d._ref&&(c.ref=d._ref);d._key&&(c.key=d._key);d._name&&(c.name=d._name);d._guard&&(c.guard=d._guard);d.data=d._ref=d._key=d._name=d._guard=null}c.svg=b||"svg"==c.tag}else n(a)?(c.type=2,c.body=a):k(a)&&a.nodeType&&(c.type=1,c.el=a,c.tag=a.nodeName);return c}function r(a){1==a.type?(a.el||(a.el=a.svg?v.createElementNS("http://www.w3.org/2000/svg",a.tag):v.createElement(a.tag),a.props&&D(a)),f(a.body)?a.body.forEach(function(b){r(b);a.el.appendChild(b.el)}):n(a.body)&&(a.el.textContent=a.body)):
2==a.type&&(a.el=v.createTextNode(a.body))}function z(a,b){a.el=b;var c=b.children;if(f(a.body))for(var d=0;d<a.body.length;d++)z(a.body[d],c[d])}function B(a,b){return null!==b.key&&b.key===a.key||b.type===a.type&&(2===b.type||null!==b.tag&&b.tag===a.tag||null!==b.name&&b.name===a.name)}function L(a,b,c,d,e,g){if(null!==a.key&&c&&a.key in c)return b[c[a.key]];e=e||0;if(e>b.length-1)return null;g=0===g?0:g||b.length-1;for(c=e;c<=g;c++)if(e=b[c],e.el&&B(e,a)&&(null===e.key||!d||d&&!(e.key in d)))return e;
