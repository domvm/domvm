...
deepSet:function(c,d,n,b,q,f){d=d.split(".");var x=d.pop();d.forEach(function(b){c[b]||(c[b]={});c=c[b]});if(k.isFunc(c[x]))c[x](n,b,q,f);else c[x]=n},deepGet:function(c,d){var n=d.split(".");do c=c[n.shift()];while(n.length);return c},keyedIdx:function(c,d,n,b,q){for(b=0;b<d.length;b++)if(q=d[b],q.key===c)if(n){if(q.vm&&q.vm.ident[0]===n)return b}else return b;return-1},raft:function(c){function d(){n=0;c.apply(b,q)}if(!u)return c;var n,b,q;return function(){b=this;q=arguments;n||(n=u(d))}}};y.utils=
k})(domvm);(function(y){function u(a){for(I.repaint&&m.repaint(a);a=J.shift();)a[0].apply(null,a.slice(1))}function t(a,h){return!1===h?null:null==h&&null!=a?a:m.isVal(h)||m.isObj(h)||m.isArr(h)||m.isFunc(h)?h:null}function k(a,h,l,b,B,e){function g(){var a=E(h);if(v===a)return!0;for(var e=0;e<a.length;e++)if(a[e]!==v[e])return v=a,!0;return!1}function A(a,h,e){if(e)a[h]=a[h]||[],a[h].push(e);else for(var l in h)a[l]=a[l]||[],a[l].push(h[l])}function f(a,h,l){B=a;e=h;p.update(l,!1);null!=p.node&&(p.node.idx=
e,B.body[e]=p.node);return w(0,!1)}function k(a){return null==a?"":a}function w(a,c){c=!1!==c;if(a){for(var b=p;a--&&b.parent;)b=b.parent;b.redraw(0,!0);return b.vm}(b=p.node)&&d(p,"willRedraw",p);var F=p.refs,A=p.body;p.refs={};p.body=[];var r=g()&&p.render.call(p.api,p,h,l),f;if(!1===r||(f=q(r,B,e,p,!0))&&D(b,f))return b.moved=!0,b.wasSame=!0,p.refs=F,p.body=A,p;f.vm=p;p.node=f;F=m.isVal(l)&&"^"===l[0]?l.substr(1):m.isVal(f.ref)&&"^"===f.ref[0]?f.ref.substr(1):null;f.key=null!=l?l:f.key;for(A=B;A;)A.vm&&
(p.parent||(p.parent=A.vm,A.vm.body.push(p)),null!==F&&m.deepSet(A.vm.refs,F,f)),A=A.parent;if((F=b)&&b.el&&(f.type!==b.type||f.tag!==b.tag))var F=null,k=!0,M=b.el.parentNode;x(f,F);B&&(B.body[e]=f);c&&(b&&n(b),!b&&C||z(f,null,f.el),k&&((M||f.parent.el).insertBefore(f.el,M.childNodes[b.idx]),p.node=f));b&&d(p,"didRedraw",p);c&&b&&J.length&&u(f);return p}var C=!B;m.isArr(a)&&(h=a[1],l=a[2],b=a[3],a=a[0]);l=t(h,l);var v=!0,E=function(a){return!0},p={api:{},node:null,ident:[a,l],model:h,opts:b||{},render:null,
update:function(a,e){null==a||l===h&&!m.isVal(l)||(d(p,"willUpdate",p,a),h=p.model=a);return!1!==e?w(0):p},on:function(a,h){A(p.events,a,h)},hook:function(a,h){p.hooks=p.hooks||{};A(p.hooks,a,h)},diff:function(a){E=a},events:{},hooks:null,redraw:I.debounce?m.raft(w):w,patch:function(a,h){var e=null!=a.el;if(m.isObj(h)){a.props=a.props||{};var l="class"in h?(k(a["class"])+" "+k(h["class"])).trim():a.props["class"],b="style"in h?h.style:a.props.style;e&&(e=Object.create(a.props),e["class"]=l,e.style=
b,e={tag:a.tag,el:a.el,ns:a.ns,props:e},r(e,a));a.props["class"]=l;a.props.style=b}else l=a.parent,e=x(q(h,l,a.idx,p),a),l.body[a.idx]=e},emit:function(a){for(var h=Array.prototype.slice.call(arguments),e=p,l;e;){if(l=e.events[a]){h[0]=l;m.execAll.apply(null,h);break}e=e.parent}},refs:{},parent:null,body:[],mount:function(a,h){p.node||w(0);if(null==a)return p;var e=null;h&&(a.textContent="",e=a,a=null);z(p.node,e,null,a);u(p.node);return p},attach:function(a){p.node||w(0);c(p.node,a);return p},unmount:function(){n(p.node)},
moveTo:f};b&&b.hooks&&p.hook(b.hooks);m.execAll(H,p);p.render=a.call(p.api,p,h,l);return B?f(B,e):p}function c(a,h){a.el=h;h._node=a;for(var l in a.props){var b=a.props[l],B=m.isEvProp(l)?l:"."===l[0]?l.substr(1):null;null!==B&&(h[B]=b)}if(m.isArr(a.body))for(l=0;l<a.body.length;l++)c(a.body[l],h.childNodes[l])}function d(a,h,l,b,B,e){if(a&&a.hooks&&(a=a.hooks[h]))if("did"==h.substr(0,3))J.push([m.execAll,a,l,b,B,e]);else return m.execAll(a,l,b,B,e)}function n(a,h){var l=a.el&&!a.moved;if(l){var c=
d(a.vm,"willUnmount",a.vm),B=d(a,"willRemove",a),e=c||B;a.removed=!0}a.wasSame?a.wasSame=!1:(m.isArr(a.body)&&a.body.forEach(function(a,l){n(a,h||e)}),h||(e?e.then(function(){b(a,l,!0)}):b(a,l)));a.moved=!1}function b(a,h,l){null!=a.el&&a.el.parentNode?h&&(a.el.parentNode.removeChild(a.el),a.el=null,g(a),d(a.vm,"didUnmount",a.vm),d(a,"didRemove",a),l&&u(a.parent)):g(a)}function q(a,h,l,b,B){var e=a;a=0<K.length?K.pop():{type:null,key:null,ref:null,idx:null,parent:null,moved:!1,wasSame:!1,removed:!1,
...
" ")},N[e]=c);a.tag=c.tag;if(c.id||c["class"])e=a.props||{},c.id&&null==e.id&&(e.id=c.id),c["class"]&&(a["class"]=c["class"],e["class"]=c["class"]+(null!=e["class"]?" "+e["class"]:"")),a.props=e;if(a.props){var e=a.props,g;for(g in e)!m.isEvProp(g)&&m.isFunc(e[g])&&("href"==g?(e.onclick=e[g],e.href=e[g].href):e[g]=e[g]()),m.isDynProp(a.tag,g)&&(e["."+g]=e[g]);if(m.isObj(e.style))for(var d in e.style)g=e.style[d],m.isFunc(g)&&(e.style[d]=g());a.key=m.isVal(e._key)?e._key:m.isVal(e._ref)?e._ref:m.isVal(e.id)?
e.id:m.isVal(e.name)?e.name:null;null!=e._key&&delete e._key;for(var q in e)"_"==q[0]&&(a[q.substr(1)]=e[q],delete e[q])}}else m.isVal(e)?(a.type=m.TYPE_TEXT,a.body=e):m.isElem(e)&&(a.type=m.TYPE_ELEM,a.el=e,a.tag=e.nodeName.toLowerCase());null!==a.ref&&m.deepSet(b.refs,a.ref,a);a.parent=h;a.idx=l;a.ns=h&&h.ns?h.ns:"svg"===a.tag||"math"===a.tag?a.tag:null;B||a.diff||!m.isArr(a.body)||f(a,b);return a}function f(a,h){for(var l=0,c=a.body.length;l<c;l++){var b=a.body[l],e=null,g=null,f=!1,d=!1;m.isFunc(b)&&
(b=b());if(null==b)f=!0;else{var n=m.isArr(b),r=n?!1:m.isObj(b);if(n)b.length?b._expl?d=!0:"string"==typeof b[0]&&""!==b[0]?(g=q(b,a,l,h),e=g.key):m.isFunc(b[0])?e=t(b[1],b[2]):d=!0:f=!0;else if(r)if(m.isFunc(b.redraw))b.moveTo(a,l),g=b.node,e=b.ident[1];else if(m.isElem(b))g=q(b,a,l,h);else{a.body[l--]=""+b;continue}else""===b?f=!0:0<l&&a.body[l-1].type===m.TYPE_TEXT?(a.body[l-1].body+=""+b,f=!0):g=q(""+b,a,l,h)}f||d?(d?m.insertArr(a.body,b,l,1):a.body.splice(l,1),c=a.body.length,l--):(null!==e&&
(a.hasKeys=!0),a.body[l]=g||b)}a.body._init=!0}function x(a,h){if(D(h,a))return h.moved=!0,h.wasSame=!0,h;h&&(d(a,"willRecycle",h,a),w(h,a),d(a,"didRecycle",h,a));if(m.isArr(a.body)){if(!a.body._init){for(var b=a;!b.vm;)b=b.parent;f(a,b.vm)}var c=0;a.body.forEach(function(b,e){var l=m.isArr(b);if(h){var g=C(b,a,h,c);if(null!==g){var f=g[0],g=g[1];f===c&&c++;f=h.body[f];f.vm?l?2===g?f.vm.moveTo(a,e,b[1]):1===g&&k(b[0],b[1],b[2],b[3],a,e):b.vm&&2===g&&b.vm===f.vm&&f.vm.moveTo(a,e):a.body[e]=x(b,f);
return}}l?k(b[0],b[1],b[2],b[3],a,e):a.body[e]=x(b)})}return a}function z(a,h,b,c){for(var g=!a.el;b&&b._node.removed;)b=b.nextSibling;g&&a.vm&&d(a.vm,"willMount",a.vm);if(a.type==m.TYPE_ELEM)if(g&&(a.el=h||(a.ns?L.createElementNS(G[a.ns],a.tag):L.createElement(a.tag)),a.props&&r(a)),m.isArr(a.body)){h=0;for(var e=a.el.firstChild;h<a.body.length;h++)e=z(a.body[h],null,e)}else m.isVal(a.body)&&(a.raw?a.el.innerHTML=a.body:g&&(a.el.textContent=a.body));else a.type==m.TYPE_TEXT&&g&&(a.el=L.createTextNode(a.body));
a.el._node=a;h=a.parent;b!==a.el&&(c||h&&h.el)&&(h=g?"Insert":"Reinsert",d(a,"will"+h,a),(c||a.parent.el).insertBefore(a.el,b),d(a,"did"+h,a));g&&a.vm&&a.vm.hooks&&!a.moved&&d(a.vm,"didMount",a.vm);return b!==a.el?b:b.nextSibling}function C(a,h,b,c,g){var e=m.isArr(a),f=e?t(a[1],a[2]):a.key,d=b.hasKeys,q=h.hasKeys;b=b.body;h=h.body;if(null!==f&&d)return a=m.keyedIdx(f,b,e?a[0]:null),-1<a?[a,2]:null;c=c||0;if(c>b.length-1)return null;g=0===g?0:g||b.length-1;for(f=null;c<=g;c++)if(d=b[c],null!==d&&
d.el)if(e&&d.vm){if(d.vm.ident[0]===a[0]){if(d.vm.ident[1]===t(a[1],a[2]))return[c,2];!f&&q&&-1==m.keyedIdx(d.key,h,d.vm.ident[0])&&(f=[c,1])}}else if(a.type===d.type&&(a.type===m.TYPE_TEXT||null!==a.tag&&a.tag===d.tag)&&(null===d.key||!q||-1==m.keyedIdx(d.key,h,d.vm?d.vm.ident[0]:null)))return[c,1];return f}function D(a,b){if(a&&a.diff&&b.diff&&a.diff[0]===b.diff[0]){var c=a.diff.slice(1).concat(b.diff.slice(1));return!b.diff[0].apply(null,c)}return!1}function w(a,b){if(a.el)if(b.el=a.el,a.el=null,
...
f=null;if(m.isFunc(a))e=a.call(b,c,l,g);else if(m.isArr(a))f=a.slice(1),e=a[0].apply(b,f.concat(c,l,g));else if(m.isObj(a))for(var d in a){var q=a[d];null!=q&&"_"!=d[0]&&c.target.matches(d)&&(m.isArr(q)?(f=q.slice(1),e=q[0].apply(b,f.concat(c,l,g))):m.isFunc(q)&&(e=q.call(b,c,l,g)))}!1===e&&(c.preventDefault(),c.stopPropagation());g.opts.hasOwnProperty("watch")&&g.opts.watch.fire({type:"event",vm:g,node:l,event:c,data:f})}}function r(a,b){var c=!b;b=b||{};if(b.props||a.props){var g=b.props||{},f=
a.props||{},e=g.style,d=f.style;if(m.isObj(e)||m.isObj(d))O(a.el,a.tag,e||{},d||{},Q,v,a.ns,c,a),g.style=f.style=null;O(a.el,a.tag,g,f,R,P,a.ns,c,a);d&&(f.style=d)}}function O(a,b,c,g,f,e,d,q,n){for(var r in g)if(b=g[r],null!==b){var k="."===r[0]?a[r.substr(1)]:c[r];b===k||m.isArr(b)&&m.isArr(k)&&m.cmpArr(b,k)||f(a,r,b,d,q,n)}for(r in c)null!==c[r]&&null==g[r]&&e(a,r,d,q)}function Q(a,b,c){a.style[b]=m.autoPx(b,c)}function v(a,b){a.style[b]=""}function R(a,b,c,g,f,e){if("class"===b)a.className=c;
