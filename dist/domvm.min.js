...
a.el;a.el=null;e.el&&(e.el._node=e);if(e.type===k.TYPE_TEXT&&e.body!==a.body)e.el.nodeValue=e.body;else{q(e,a);var b=!k.isArr(e.body),c=!k.isArr(a.body);b&&e.body!==a.body?c&&e.el.firstChild?e.el.firstChild.nodeValue=e.body:e.raw?e.el.innerHTML=e.body:e.el.textContent=e.body:c&&!b&&(e.el.textContent="");a.moved=!0}}function D(a){if(a in L)return L[a];var e={tag:null,id:null,"class":null};e.tag=a.replace(/^([\w\-]+)?(?:#([\w\-]+))?((?:\.[\w\-]+)+)?$/,function(a,b,d,c){d&&(e.id=d);c&&(e["class"]=c.replace(/\./g,
" ").trim());return b||"div"});return L[a]=e}function y(a,e,b,c){return function(b){var h,g=b.target._node,f=null;if(k.isFunc(a))h=a.call(e,b,g,c);else if(k.isArr(a))f=a.slice(1),h=a[0].apply(e,f.concat(b,g,c));else if(k.isObj(a))for(var p in a){var q=a[p];b.target.matches(p)&&(k.isArr(q)?(f=q.slice(1),h=q[0].apply(e,f.concat(b,g,c))):k.isFunc(q)&&(h=q.call(e,b,g,c)))}!1===h&&(b.preventDefault(),b.stopPropagation());c.opts.hasOwnProperty("watch")&&c.opts.watch.fire({type:"event",vm:c,node:g,event:b,
data:f})}}function q(a,e){var b=!e;e=e||{};if(e.props||a.props){var c=e.props||{},d=a.props||{},h=c.style,g=d.style;if(k.isObj(h)||k.isObj(g))F(a.el,a.tag,h||{},g||{},O,C,a.ns,b),c.style=d.style=null;F(a.el,a.tag,c,d,M,I,a.ns,b);g&&(d.style=g)}}function F(a,b,c,h,d,g,f,k){for(var q in h)null!==h[q]&&("."===q[0]?a[q.substr(1)]!==h[q]:h[q]!==c[q])&&d(a,q,h[q],f,k);for(q in c)null!==c[q]&&null==h[q]&&g(a,q,f,k)}function O(a,b,c){a.style[b]=k.autoPx(b,c)}function C(a,b){a.style[b]=""}function M(a,b,c,
h,d){"."===b[0]?(b=b.substr(1),"svg"===h?a[b].baseVal=c:a[b]=c):"class"===b?a.className=c:"id"===b||k.isEvProp(b)?a[b]=c:!1===c?I(a,b,h,d):a.setAttribute(b,!0===c?"":c)}function I(a,b,c,h){h||("."===b[0]?(b=b.substr(1),"svg"===c?a[b].baseVal=null:a[b]=null):"class"===b?a.className="":"id"===b||k.isEvProp(b)?a[b]=null:a.removeAttribute(b))}var E={svg:"http://www.w3.org/2000/svg",math:"http://www.w3.org/1998/Math/MathML"},L={},K="undefined"==typeof document?{}:document,N=[],J={useRaf:!0};u.view=m;u.view.config=
function(a){J=a};var H=null;u.view.extend=function(a,b){H=!H||b?[]:H;H.push(a)};var k=u.utils;return u})(domvm);(function(u){var v=/^(?:img|br|input|col|link|meta|area|base|command|embed|hr|keygen|param|source|track|wbr)$/,n=u.utils;u.html=function(m){var c="";switch(m.type){case n.TYPE_ELEM:c+="<"+m.tag;if(m.props){var f=n.isVal(m.props.style)?m.props.style:"",l=n.isObj(m.props.style)?m.props.style:null;if(l)for(var b in l)null!==l[b]&&(f+=n.camelDash(b)+": "+n.autoPx(b,l[b])+"; ");for(b in m.props)n.isEvProp(b)||"."===b[0]||(l=m.props[b],n.isFunc(l)&&(l=l()),n.isObj(l)||(!0===l?c+=" "+b:!1!==l&&null!==l&&
