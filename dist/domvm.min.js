...
var g,a,h;return function(){a=this;h=arguments;g||(g=t(f))}}};w.utils=n})(domvm);(function(w){function t(){for(var b;b=J.pop();)b[0].apply(null,b.slice(1))}function u(b,k){return!1===k?null:null==k&&null!=b?b:m.isVal(k)||m.isObj(k)||m.isArr(k)||m.isFunc(k)?k:null}function n(b,k,p,a,y,e){function l(b,k,e){if(e)b[k]=b[k]||[],b[k].push(e);else for(var p in k)b[p]=b[p]||[],b[p].push(k[p])}function d(b,k,p){y=b;e=k;r.update(p,!1);null!=r.node&&(y.body[e]=r.node);return n(0,!1)}function x(b){return null==b?"":b}function n(b,c){if(b){for(var a=r;b--&&a.parent;)a=a.parent;a.redraw(0,
!0);return a.vm}(a=r.node)&&f(r,"willRedraw",r);var C=r.refs;r.refs={};r.body=[];var l=r.render.call(r.api,r,k,p),d;if(!1===l||(d=h(l,y,e,r,!0))&&z(a,d))return a.moved=!0,a.wasSame=!0,r.refs=C,r;d.vm=r;r.node=d;C=m.isVal(p)&&"^"===p[0]?p.substr(1):m.isVal(d.ref)&&"^"===d.ref[0]?d.ref.substr(1):null;d.key=null!=p?p:d.key;for(l=y;l;)l.vm&&(r.parent||(r.parent=l.vm,l.vm.body.push(r)),null!==C&&m.deepSet(l.vm.refs,C,d)),l=l.parent;if((C=a)&&(d.type!==a.type||d.tag!==a.tag))var C=null,x=!0,K=a.el.parentNode;
q(d,C);y&&(y.body[e]=d);!1!==c&&(a&&g(a),!a&&A||v(d,null,d.el),x&&(K||d.parent.el).insertBefore(d.el,K.childNodes[a.idx]));a&&f(r,"didRedraw",r);!1!==c&&m.tick(t,2);return r}var A=!y;m.isArr(b)&&(k=b[1],p=b[2],a=b[3],b=b[0]);p=u(k,p);var r={api:{},node:null,view:[b,p],model:k,opts:a||{},render:null,update:function(b,e){null==b||p===k&&!m.isVal(p)||(k=r.model=b);return!1!==e?n(0):r},on:function(b,k){l(r.events,b,k)},hook:function(b,k){r.hooks=r.hooks||{};l(r.hooks,b,k)},events:{},hooks:null,redraw:G.useRaf?
m.raft(n):n,patch:function(b,k){var e=null!=b.el;if(m.isObj(k)){var p="class"in k?(x(b["class"])+" "+x(k["class"])).trim():b.props["class"],a="style"in k?k.style:b.props.style;e&&(e=Object.create(b.props),e["class"]=p,e.style=a,e={tag:b.tag,el:b.el,ns:b.ns,props:e},D(e,b));b.props["class"]=p;b.props.style=a}else p=b.parent,e=q(h(k,p,b.idx,r),b),p.body[b.idx]=e},emit:function(b){for(var k=Array.prototype.slice.call(arguments),e=r,p;e;){if(p=e.events[b]){k[0]=p;m.execAll.apply(null,k);break}e=e.parent}},
refs:{},parent:null,body:[],mount:function(b,k){var e=null;k&&(b.textContent="",e=b,b=null);v(r.node,e,null,b);return r},attach:function(b){c(r.node,b);return r},unmount:function(){g(r.node)},moveTo:d,updIdx:function(b){e=b}};a&&a.hooks&&r.hook(a.hooks);m.execAll(F,r);r.render=b.call(r.api,r,k,p);return y?d(y,e):n(0)}function c(b,k){b.el=k;k._node=b;for(var p in b.props){var a=b.props[p],y=m.isEvProp(p)?p:"."===p[0]?p.substr(1):null;null!==y&&(k[y]=a)}if(m.isArr(b.body))for(p=0;p<b.body.length;p++)c(b.body[p],
k.childNodes[p])}function f(b,k,p,a,c,e){if(b&&b.hooks&&(b=b.hooks[k]))if(G.useRaf&&"did"==k.substr(0,3))J.push([m.execAll,b,p,a,c,e]);else return m.execAll(b,p,a,c,e)}function g(b,k){var p=b.el&&!b.moved;if(p){var c=f(b.vm,"willUnmount",b.vm),y=f(b,"willRemove",b),e=c||y;b.removed=!0}b.wasSame?b.wasSame=!1:(m.isArr(b.body)&&b.body.forEach(function(b,p){g(b,k||e)}),k||(e?e.then(function(){a(b,p)}):a(b,p)));b.moved=!1}function a(b,k){null!=b.el&&b.el.parentNode&&(k&&(b.el.parentNode.removeChild(b.el),
b.el=null,f(b.vm,"didUnmount",b.vm),f(b,"didRemove",b)),m.isArr(b.body)&&b.body.forEach(function(b,k){a(b,!b.moved)}))}function h(b,k,p,a,c){var e=b;b={type:null,key:null,ref:null,idx:null,parent:null,moved:!1,wasSame:!1,removed:!1,hooks:null,tag:null,"class":null,ns:null,guard:!1,raw:!1,props:null,el:null,hasKeys:!1,body:null};m.isFunc(e)&&(e=e());var d=e.length;if(m.isArr(e)&&d){b.type=m.TYPE_ELEM;if(1<d){var l=1;m.isObj(e[1])&&!m.isElem(e[1])&&(b.props=e[1],l=2);b.body=d==l+1?m.isVal(e[l])?e[l]:
m.isFunc(e[l])?e[l]():e.slice(l):e.slice(l)}e=e[0];d=L[e];d||(d=["",""],d={tag:(e.match(/^[-\w]+/)||["div"])[0],id:(e.match(/#([-\w]+)/)||d)[1],"class":(e.match(/\.([-\w.]+)/)||d)[1].replace(/\./g," ")},L[e]=d);b.tag=d.tag;if(d.id||d["class"])e=b.props||{},d.id&&null==e.id&&(e.id=d.id),d["class"]&&(b["class"]=d["class"],e["class"]=d["class"]+(null!=e["class"]?" "+e["class"]:"")),b.props=e;if(b.props){var e=b.props,h;for(h in e)!m.isEvProp(h)&&m.isFunc(e[h])&&("href"==h?(e.onclick=e[h],e.href=e[h].href):
e[h]=e[h]()),m.isDynProp(b.tag,h)&&(e["."+h]=e[h]);if(m.isObj(e.style))for(var f in e.style)h=e.style[f],m.isFunc(h)&&(e.style[f]=h());m.isObj(e._hooks)&&(b.hooks=e._hooks,e._hooks=null);b.key=m.isVal(e._key)?e._key:m.isVal(e._ref)?e._ref:m.isVal(e.id)?e.id:m.isVal(e.name)?e.name:null;null!=e._ref&&(b.ref=e._ref);e._raw&&(b.raw=!0);null!=e._data&&(b.data=e._data);e._diff&&(b.diff=e._diff);e._ref=e._key=e._raw=e._data=e._diff=null}}else m.isVal(e)?(b.type=m.TYPE_TEXT,b.body=e):m.isElem(e)&&(b.type=
m.TYPE_ELEM,b.el=e,b.tag=e.nodeName.toLowerCase());null!==b.ref&&m.deepSet(a.refs,b.ref,b);b.parent=k;b.idx=p;b.ns=k&&k.ns?k.ns:"svg"===b.tag||"math"===b.tag?b.tag:null;c||b.diff||!m.isArr(b.body)||x(b,a);return b}function x(b,k){for(var a=0,c=b.body.length;a<c;a++){var d=b.body[a],e=null,l=null,f=!1,x=!1;m.isFunc(d)&&(d=d());if(null==d)f=!0;else{var g=m.isArr(d),q=g?!1:m.isObj(d);if(g)d.length?"string"==typeof d[0]&&""!==d[0]?(l=h(d,b,a,k),e=l.key):m.isFunc(d[0])?e=u(d[1],d[2]):x=!0:f=!0;else if(q)if(m.isFunc(d.redraw))d.moveTo(b,
