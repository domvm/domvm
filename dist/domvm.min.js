...
e[1].redraw||l.isElem(e[1])||(b.props=e[1],h=2);b.body=t==h+1?l.isVal(e[h])?e[h]:l.isFunc(e[h])?e[h]():e.slice(h):e.slice(h)}e=e[0];t=M[e];t||(t=["",""],t={tag:(e.match(/^[-\w]+/)||["div"])[0],id:(e.match(/#([-\w]+)/)||t)[1],"class":(e.match(/\.([-\w.]+)/)||t)[1].replace(/\./g," ")},M[e]=t);b.tag=t.tag;if(t.id||t["class"])e=b.props||{},t.id&&null==e.id&&(e.id=t.id),t["class"]&&(b["class"]=t["class"],e["class"]=t["class"]+(null!=e["class"]?" "+e["class"]:"")),b.props=e;if(b.props){var e=b.props,d;
for(d in e)!l.isEvProp(d)&&l.isFunc(e[d])&&("href"==d?(e.onclick=e[d],e.href=e[d].href):e[d]=e[d]()),l.isDynProp(b.tag,d)&&(e["."+d]=e[d]);if(l.isObj(e.style))for(var m in e.style)d=e.style[m],l.isFunc(d)&&(e.style[m]=d());l.isObj(e._hooks)&&(b.hooks=e._hooks,e._hooks=null);b.key=l.isVal(e._key)?e._key:l.isVal(e._ref)?e._ref:l.isVal(e.id)?e.id:l.isVal(e.name)?e.name:null;null!=e._ref&&(b.ref=e._ref);e._raw&&(b.raw=!0);null!=e._data&&(b.data=e._data);e._diff&&(b.diff=e._diff);e._ref=e._key=e._raw=
e._data=e._diff=null}}else l.isVal(e)?(b.type=l.TYPE_TEXT,b.body=e):l.isElem(e)&&(b.type=l.TYPE_ELEM,b.el=e,b.tag=e.nodeName.toLowerCase());null!==b.ref&&l.deepSet(c.refs,b.ref,b);b.parent=g;b.idx=k;b.ns=g&&g.ns?g.ns:"svg"===b.tag||"math"===b.tag?b.tag:null;a||b.diff||!l.isArr(b.body)||u(b,c);return b}function u(b,g){for(var k=0,c=b.body.length;k<c;k++){var a=b.body[k],e=null,h=null,d=!1,v=!1;l.isFunc(a)&&(a=a());if(null==a)d=!0;else{var n=l.isArr(a),u=n?!1:l.isObj(a);if(n)a.length?"string"==typeof a[0]&&
""!==a[0]?(h=m(a,b,k,g),e=h.key):l.isFunc(a[0])?e=w(a[1],a[2]):v=!0:d=!0;else if(u)if(l.isFunc(a.redraw))a.moveTo(b,k),h=a.node,e=a.view[1];else if(l.isElem(a))h=m(a,b,k,g);else{b.body[k--]=""+a;continue}else""===a?d=!0:0<k&&b.body[k-1].type===l.TYPE_TEXT?(b.body[k-1].body+=""+a,d=!0):h=m(""+a,b,k,g)}d||v?(v?l.insertArr(b.body,a,k,1):b.body.splice(k,1),c=b.body.length,k--):(null!==e&&(b.hasKeys=!0),b.body[k]=h||a)}b.body._init=!0}function z(b,g){if(D(g,b))return g.moved=!0,g.wasSame=!0,g;g&&(d(b,
"willRecycle",g,b),B(g,b),d(b,"didRecycle",g,b));if(l.isArr(b.body)){if(!b.body._init){for(var a=b;!a.vm;)a=a.parent;u(b,a.vm)}var c=0;b.body.forEach(function(a,e){var k=l.isArr(a);if(g){var h=C(a,b,g,c);if(null!==h){var d=h[0],h=h[1];d===c&&c++;d=g.body[d];d.vm?k?2===h?d.vm.moveTo(b,e,a[1]):1===h&&f(a[0],a[1],a[2],a[3],b,e):a.vm&&2===h&&a.vm===d.vm&&d.vm.moveTo(b,e):b.body[e]=z(a,d);return}}k?f(a[0],a[1],a[2],a[3],b,e):b.body[e]=z(a)})}return b}function p(b,g,a,c){for(var m=!b.el;a&&a._node.removed;)a=
a.nextSibling;m&&d(b.vm,"willMount",b.vm);if(b.type==l.TYPE_ELEM)if(m&&(b.el=g||(b.ns?K.createElementNS(F[b.ns],b.tag):K.createElement(b.tag)),b.props&&h(b)),l.isArr(b.body)){g=0;for(var e=b.el.firstChild;g<b.body.length;g++)e=p(b.body[g],null,e)}else l.isVal(b.body)&&(b.raw?b.el.innerHTML=b.body:m&&(b.el.textContent=b.body));else b.type==l.TYPE_TEXT&&m&&(b.el=K.createTextNode(b.body));b.el._node=b;g=b.parent;a!==b.el&&(c||g&&g.el)&&(g=m?"Insert":"Reinsert",d(b,"will"+g,b),(c||b.parent.el).insertBefore(b.el,
a),d(b,"did"+g,b));m&&b.vm&&b.vm.hooks&&!b.moved&&d(b.vm,"didMount",b.vm);return a!==b.el?a:a.nextSibling}function C(b,g,a,c,h){var e=l.isArr(b),d=e?w(b[1],b[2]):b.key,m=a.hasKeys,v=g.hasKeys;a=a.body;g=g.body;if(null!==d&&m)return b=l.keyedIdx(d,a,e?b[0]:null),-1<b?[b,2]:null;c=c||0;if(c>a.length-1)return null;h=0===h?0:h||a.length-1;for(d=null;c<=h;c++)if(m=a[c],null!==m&&m.el)if(e&&m.vm){if(m.vm.view[0]===b[0]){if(m.vm.view[1]===w(b[1],b[2]))return[c,2];!d&&v&&-1==l.keyedIdx(m.key,g,m.vm.view[0])&&
(d=[c,1])}}else if(b.type===m.type&&(b.type===l.TYPE_TEXT||null!==b.tag&&b.tag===m.tag)&&(null===m.key||!v||-1==l.keyedIdx(m.key,g,m.vm?m.vm.view[0]:null)))return[c,1];return d}function D(b,a){if(b&&b.diff&&a.diff&&b.diff[0]===a.diff[0]){var c=b.diff.slice(1).concat(a.diff.slice(1));return!a.diff[0].apply(null,c)}return!1}function B(b,a){if(b.el)if(a.el=b.el,b.el=null,a.el&&(a.el._node=a),a.type===l.TYPE_TEXT&&a.body!==b.body)a.el.nodeValue=a.body;else{h(a,b);var c=!l.isArr(a.body),d=!l.isArr(b.body);
c&&a.body!==b.body?d&&a.el.firstChild?a.el.firstChild.nodeValue=a.body:a.raw?a.el.innerHTML=a.body:a.el.textContent=a.body:d&&!c&&(a.el.textContent="");b.moved=!0}}function v(b,a,c,d){return function(c){var e,h=c.target._node,k=null;if(l.isFunc(b))e=b.call(a,c,h,d);else if(l.isArr(b))k=b.slice(1),e=b[0].apply(a,k.concat(c,h,d));else if(l.isObj(b))for(var m in b){var v=b[m];null!=v&&"_"!=m[0]&&c.target.matches(m)&&(l.isArr(v)?(k=v.slice(1),e=v[0].apply(a,k.concat(c,h,d))):l.isFunc(v)&&(e=v.call(a,
c,h,d)))}!1===e&&(c.preventDefault(),c.stopPropagation());d.opts.hasOwnProperty("watch")&&d.opts.watch.fire({type:"event",vm:d,node:h,event:c,data:k})}}function h(b,a){var c=!a;a=a||{};if(a.props||b.props){var d=a.props||{},h=b.props||{},e=d.style,m=h.style;if(l.isObj(e)||l.isObj(m))N(b.el,b.tag,e||{},m||{},O,y,b.ns,c,b),d.style=h.style=null;N(b.el,b.tag,d,h,P,H,b.ns,c,b);m&&(h.style=m)}}function N(b,a,c,d,h,e,m,v,n){for(var u in d)if(a=d[u],null!==a){var f="."===u[0]?b[u.substr(1)]:c[u];a===f||l.isArr(a)&&
l.isArr(f)&&l.cmpArr(a,f)||h(b,u,a,m,v,n)}for(u in c)null!==c[u]&&null==d[u]&&e(b,u,m,v)}function O(b,a,c){b.style[a]=l.autoPx(a,c)}function y(b,a){b.style[a]=""}function P(b,a,c,d,h,e){if("."===a[0])a=a.substr(1),"svg"===d?b[a].baseVal=c:b[a]=c;else if("class"===a)b.className=c;else if("id"===a)b[a]=c;else if(l.isEvProp(a)){for(d=e;!d.vm;)d=d.parent;b[a]=v(c,d.vm.opts.evctx||d.vm.model||null,e,d.vm)}else!1===c?H(b,a,d,h):b.setAttribute(a,!0===c?"":c)}function H(b,a,c,d){d||("."===a[0]?(a=a.substr(1),
"svg"===c?b[a].baseVal=null:b[a]=null):"class"===a?b.className="":"id"===a||l.isEvProp(a)?b[a]=null:b.removeAttribute(a))}var F={svg:"http://www.w3.org/2000/svg",math:"http://www.w3.org/1998/Math/MathML"},K="undefined"==typeof document?{}:document,M={},I=[],L=[],J={useRaf:!0};x.view=f;x.view.config=function(b){J=b};var G=null;x.view.extend=function(b,a){G=!G||a?[]:G;G.push(b)};var l=x.utils;return x})(domvm);(function(x){var r=/^(?:img|br|input|col|link|meta|area|base|command|embed|hr|keygen|param|source|track|wbr)$/,w=x.utils;x.html=function(f){var c="";switch(f.type){case w.TYPE_ELEM:c+="<"+f.tag;if(f.props){var d=w.isVal(f.props.style)?f.props.style:"",n=w.isObj(f.props.style)?f.props.style:null;if(n)for(var a in n)null!==n[a]&&(d+=w.camelDash(a)+": "+w.autoPx(a,n[a])+"; ");for(a in f.props)w.isEvProp(a)||"."===a[0]||(n=f.props[a],w.isFunc(n)&&(n=n()),w.isObj(n)||(!0===n?c+=" "+a:!1!==n&&null!==n&&
