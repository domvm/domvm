...
hooks:null,redraw:I.useRaf?f.raft(x):x,patch:function(b,c){var e=b.parent,m=k(l(c,e,b.idx,q),b);e.body[b.idx]=m},emit:function(b){for(var c=Array.prototype.slice.call(arguments,1),e=q;e;){if(e.events[b]){f.execAll(e.events[b],c);break}e=e.parent}},refs:{},parent:null,mount:function(b,c){q.hooks&&f.execAll(q.hooks.willMount);c&&(b.textContent="");C(q.node,c?b:null);c||b.insertBefore(q.node.el,null);q.hooks&&f.execAll(q.hooks.didMount);return q},attach:function(b){a(q.node,b);return q},unmount:function(){A(q.hooks,
"Unmount",u,[])},moveTo:g,updIdx:function(b){p=b}};m&&m.hooks&&q.hook(m.hooks);f.execAll(G,[q]);q.render=b.call(q.api,q,c,z);return e?g(e,p):x(0)}function a(b,c){b.el=c;c._node=b;for(var z in b.props){var m=b.props[z],e=f.isEvProp(z)?z:"."===z[0]?z.substr(1):null;null!==e&&(c[e]=m)}if(f.isArr(b.body))for(z=0;z<b.body.length;z++)a(b.body[z],c.childNodes[z])}function d(b,c){f.isArr(b.body)&&(b.body.forEach(function(b,c){b&&(b.vm&&!b.moved?b.vm.unmount():d(b,!0))}),b.body=null);b.vm=null;c&&b.el&&b.el.parentNode&&
A(b.hooks,"Remove",y,[b])}function y(b){b.el.parentNode.removeChild(b.el);b.el=null}function l(b,c,d,m){var e=b,p={type:null,key:null,ref:null,idx:null,parent:null,moved:!1,hooks:null,tag:null,ns:null,guard:!1,raw:!1,props:null,el:null,hasKeys:!1,body:null};f.isFunc(e)&&(e=e());if(f.isArr(e)&&e.length){p.type=f.TYPE_ELEM;if(1<e.length){var h=1;f.isObj(e[1])&&(p.props=e[1],h=2);p.body=e.length==h+1?f.isVal(e[h])?e[h]:f.isFunc(e[h])?e[h]():e.slice(h):e.slice(h)}e=e[0];if(/[.#]/.test(e)){if(e=D(e),p.tag=
e.tag,e.id||e["class"])p.props=p.props||{},p.props.id=e.id,p.props["class"]=e["class"]}else p.tag=e;if(p.props){var e=p.props,g;for(g in e)f.isEvProp(g)?e[g]=x(e[g],m.opts.evctx||m.model||null,p,m):f.isFunc(e[g])&&("href"==g?(e.onclick=e[g],e.href=e[g].href):e[g]=e[g]()),f.isDynProp(p.tag,g)&&(e["."+g]=e[g]);if(f.isObj(e.style))for(var a in e.style)g=e.style[a],f.isFunc(g)&&(e.style[a]=g());f.isObj(e._hooks)&&(p.hooks=e._hooks,e._hooks=null);p.key=f.isVal(e._key)?e._key:f.isVal(e._ref)?e._ref:f.isVal(e.id)?
e.id:f.isVal(e.name)?e.name:null;e._ref&&(p.ref=e._ref);e._raw&&(p.raw=!0);e._data&&(p.data=e._data);e._guard&&(p.guard=!0);e._ref=e._key=e._raw=e._data=e._guard=null}}else f.isVal(e)&&(p.type=f.TYPE_TEXT,p.body=e);null!==p.ref&&(m.refs[p.ref]=p);p.parent=c;p.idx=d;p.ns=c&&c.ns?c.ns:"svg"===p.tag||"math"===p.tag?p.tag:null;if(f.isArr(p.body))for(c=0,d=p.body.length;c<d;c++){a=p.body[c];var e=g=null,k=h=!1;f.isFunc(a)&&(a=a());if(null==a)h=!0;else{var u=f.isArr(a),q=u?!1:f.isObj(a);if(u)a.length?f.isArr(a[0])?
k=!0:f.isFunc(a[0])?g=B(b[1],b[2]):(e=l(a,p,c,m),g=e.key):h=!0;else if(q)if(f.isFunc(a.redraw))a.moveTo(p,c),e=a.node,g=a.view[1];else{p.body[c--]=""+a;continue}else""===a?h=!0:0<c&&p.body[c-1].type===f.TYPE_TEXT?(p.body[c-1].body+=""+a,h=!0):e=l(""+a,p,c,m)}h||k?(k?f.insertArr(p.body,a,c,1):p.body.splice(c,1),d=p.body.length,c--):(null!==g&&(p.hasKeys=!0),p.body[c]=e||a)}return p}function k(b,c){c&&A(b.hooks,"Recycle",r,[c,b]);if(f.isArr(b.body)){var a=0;b.body.forEach(function(m,e){var d=f.isArr(m);
if(c){var h=n(m,b,c,a);if(null!==h){var g=h[0],h=h[1];g===a&&a++;g=c.body[g];d&&g.vm?2===h?g.vm.moveTo(b,e,m[1]):1===h&&t(m[0],m[1],m[2],m[3],b,e):b.body[e]=k(m,g);return}}d?t(m[0],m[1],m[2],m[3],b,e):b.body[e]=k(m)})}return b}function C(b,c,a){var m=!b.el;if(b.type==f.TYPE_ELEM)if(m&&(b.el=c&&c.nodeName?c:b.ns?J.createElementNS(E[b.ns],b.tag):J.createElement(b.tag),b.props&&u(b)),f.isArr(b.body)){c=0;for(var e=b.el.firstChild;c<b.body.length;c++)e=C(b.body[c],null,e)?e:e.nextSibling||null}else f.isVal(b.body)&&
(b.raw?b.el.innerHTML=b.body:m&&(b.el.textContent=b.body));else b.type==f.TYPE_TEXT&&m&&(b.el=J.createTextNode(b.body));b.el._node=b;if(a===b.el)return!1;if((c=b.parent)&&c.el)return A(b.hooks,m?"Insert":"Reinsert",v,[b,a]),!0}function v(b,c){b.parent.el.insertBefore(b.el,c)}function n(b,c,a,m,e){var d=f.isArr(b),h=d?b[2]||null:b.key,g=a.hasKeys,k=c.hasKeys;a=a.body;c=c.body;if(null!==h&&g&&(h=f.indexOfKey(h,a),-1<h))return[h,2];m=m||0;if(m>a.length-1)return null;e=0===e?0:e||a.length-1;for(h=null;m<=
e;m++)if(g=a[m],null!==g&&g.el)if(d&&g.vm){if(g.vm.view[0]===b[0]){if(g.vm.view[1]===B(b[1],b[2]))return[m,2];var u=!1;if(I.viewScan)for(var x=0;x<c.length;x++){var q=c[x];if(!q.el&&q.vm&&q.vm.view[0]===g.vm.view[0]&&q.vm.view[1]===g.vm.view[1]){u=!0;break}}u||h||!k||-1!=f.indexOfKey(g.key,c)||(h=[m,1])}}else if(b.type===g.type&&(b.type===f.TYPE_TEXT||null!==b.tag&&b.tag===g.tag)&&(null===g.key||!k||-1==f.indexOfKey(g.key,c)))return[m,1];return h}function r(b,c){c.el=b.el;b.el=null;if(c.type===f.TYPE_TEXT&&
c.body!==b.body)c.el.nodeValue=c.body;else{u(c,b);var a=!f.isArr(c.body),m=!f.isArr(b.body);a&&c.body!==b.body?m&&c.el.firstChild?c.el.firstChild.nodeValue=c.body:c.raw?c.el.innerHTML=c.body:c.el.textContent=c.body:m&&!a&&(c.el.textContent="");b.moved=!0}}function A(b,c,a,m,e,d){if(b){var h=b["will"+c];f.isArr(h)&&(h=h[0]);var g=b["did"+c];f.isArr(g)&&(g=g[0]);b=function(){a.apply(null,m);g&&g.apply(null,d||e||m)};h?(h=h.apply(null,e||m),f.isProm(h)?h.then(b):b()):b()}else a.apply(null,m)}function D(b){if(b in
K)return K[b];var c={tag:null,id:null,"class":null};c.tag=b.replace(/^([\w\-]+)?(?:#([\w\-]+))?((?:\.[\w\-]+)+)?$/,function(b,a,e,d){e&&(c.id=e);d&&(c["class"]=d.replace(/\./g," ").trim());return a||"div"});return K[b]=c}function x(b,c,a,d){return function(e){var a,h=e.target._node,g=null;if(f.isFunc(b))a=b.call(c,e,h,d);else if(f.isArr(b))g=b.slice(1),a=b[0].apply(c,g.concat(e,h,d));else if(f.isObj(b))for(var k in b){var u=b[k];e.target.matches(k)&&(f.isArr(u)?(g=u.slice(1),a=u[0].apply(c,g.concat(e,
h,d))):f.isFunc(u)&&(a=u.call(c,e,h,d)))}!1===a&&(e.preventDefault(),e.stopPropagation());d.opts.hasOwnProperty("watch")&&d.opts.watch.fire({type:"event",vm:d,node:h,event:e,data:g})}}function u(b,c){var a=!c;c=c||{};if(c.props||b.props){var d=c.props||{},e=b.props||{},k=d.style,h=e.style;if(f.isObj(k)||f.isObj(h))F(b.el,b.tag,k||{},h||{},M,N,b.ns,a),d.style=e.style=null;F(b.el,b.tag,d,e,O,H,b.ns,a);h&&(e.style=h)}}function F(b,c,a,d,e,f,h,g){for(var k in d)null!==d[k]&&("."===k[0]?b[k.substr(1)]!==
d[k]:d[k]!==a[k])&&e(b,k,d[k],h,g);for(k in a)null!==a[k]&&null==d[k]&&f(b,k,h,g)}function M(b,c,a){b.style[c]=f.autoPx(c,a)}function N(b,c){b.style[c]=""}function O(b,c,a,d,e){"."===c[0]?(c=c.substr(1),"svg"===d?b[c].baseVal=a:b[c]=a):"class"===c?b.className=a:"id"===c||f.isEvProp(c)?b[c]=a:!1===a?H(b,c,d,e):b.setAttribute(c,!0===a?"":a)}function H(b,c,a,d){d||("."===c[0]?(c=c.substr(1),"svg"===a?b[c].baseVal=null:b[c]=null):"class"===c?b.className="":"id"===c||f.isEvProp(c)?b[c]=null:b.removeAttribute(c))}
