...
function(b,a,e,c){e&&(d.id=e);c&&(d["class"]=c.replace(/\./g," ").trim());return a||"div"});return K[b]=d}function w(b,d,c,a){return function(e){var c,k=e.target._node,g=null;if(f.isFunc(b))c=b.call(d,e,k);else if(f.isArr(b))g=b.slice(1),c=b[0].apply(d,g.concat(e,k));else if(f.isObj(b))for(var p in b){var t=b[p];e.target.matches(p)&&(f.isArr(t)?(g=t.slice(1),c=t[0].apply(d,g.concat(e,k))):f.isFunc(t)&&(c=t.call(d,e,k)))}!1===c&&(e.preventDefault(),e.stopPropagation());a.opts.hasOwnProperty("watch")&&
