...
O=!0,v=c.el.parentNode;y(e,D);z&&(z.body[d]=e);a&&(c&&p(c),!c&&A||q(e,null,e.el),O&&((v||e.parent.el).insertBefore(e.el,v.childNodes[c.idx]),r.node=e));c&&f(r,"didRedraw",r);a&&c&&H.length&&t(e);return r}var A=!z;n.isArr(b)&&(h=b[1],m=b[2],c=b[3],b=b[0]);m=w(h,m);var r={api:{},node:null,view:[b,m],model:h,opts:c||{},render:null,update:function(b,d){null==b||m===h&&!n.isVal(m)||(h=r.model=b);return!1!==d?l(0):r},on:function(b,h){k(r.events,b,h)},hook:function(b,h){r.hooks=r.hooks||{};k(r.hooks,b,h)},
events:{},hooks:null,redraw:G.debounce?n.raft(l):l,patch:function(b,h){var d=null!=b.el;if(n.isObj(h)){b.props=b.props||{};var m="class"in h?(v(b["class"])+" "+v(h["class"])).trim():b.props["class"],c="style"in h?h.style:b.props.style;d&&(d=Object.create(b.props),d["class"]=m,d.style=c,d={tag:b.tag,el:b.el,ns:b.ns,props:d},I(d,b));b.props["class"]=m;b.props.style=c}else m=b.parent,d=y(g(h,m,b.idx,r),b),m.body[b.idx]=d},emit:function(b){for(var h=Array.prototype.slice.call(arguments),d=r,m;d;){if(m=
d.events[b]){h[0]=m;n.execAll.apply(null,h);break}d=d.parent}},refs:{},parent:null,body:[],mount:function(b,h){var d=null;h&&(b.textContent="",d=b,b=null);q(r.node,d,null,b);t(r.node);return r},attach:function(b){a(r.node,b);return r},unmount:function(){p(r.node)},moveTo:e,updIdx:function(b){d=b}};c&&c.hooks&&r.hook(c.hooks);n.execAll(F,r);r.render=b.call(r.api,r,h,m);return z?e(z,d):l(0)}function a(b,h){b.el=h;h._node=b;for(var m in b.props){var c=b.props[m],z=n.isEvProp(m)?m:"."===m[0]?m.substr(1):
null;null!==z&&(h[z]=c)}if(n.isArr(b.body))for(m=0;m<b.body.length;m++)a(b.body[m],h.childNodes[m])}function f(b,h,m,c,a,d){if(b&&b.hooks&&(b=b.hooks[h]))if("did"==h.substr(0,3))H.push([n.execAll,b,m,c,a,d]);else return n.execAll(b,m,c,a,d)}function p(b,h){var m=b.el&&!b.moved;if(m){var a=f(b.vm,"willUnmount",b.vm),z=f(b,"willRemove",b),d=a||z;b.removed=!0}b.wasSame?b.wasSame=!1:(n.isArr(b.body)&&b.body.forEach(function(b,m){p(b,h||d)}),h||(d?d.then(function(){c(b,m,!0)}):c(b,m)));b.moved=!1}function c(b,
h,m){null!=b.el&&b.el.parentNode?h&&(b.el.parentNode.removeChild(b.el),b.el=null,e(b),f(b.vm,"didUnmount",b.vm),f(b,"didRemove",b),m&&t(b.parent)):e(b)}function g(b,h,m,c,a){var d=b;b=0<J.length?J.pop():{type:null,key:null,ref:null,idx:null,parent:null,moved:!1,wasSame:!1,removed:!1,hooks:null,tag:null,"class":null,ns:null,guard:!1,raw:!1,props:null,el:null,hasKeys:!1,body:null,data:null,diff:null};n.isFunc(d)&&(d=d());var e=d.length;if(n.isArr(d)&&e){b.type=n.TYPE_ELEM;if(1<e){var k=1;!n.isObj(d[1])||
d[1].redraw||n.isElem(d[1])||(b.props=d[1],k=2);b.body=e==k+1?n.isVal(d[k])?d[k]:n.isFunc(d[k])?d[k]():d.slice(k):d.slice(k)}d=d[0];e=M[d];e||(e=["",""],e={tag:(d.match(/^[-\w]+/)||["div"])[0],id:(d.match(/#([-\w]+)/)||e)[1],"class":(d.match(/\.([-\w.]+)/)||e)[1].replace(/\./g," ")},M[d]=e);b.tag=e.tag;if(e.id||e["class"])d=b.props||{},e.id&&null==d.id&&(d.id=e.id),e["class"]&&(b["class"]=e["class"],d["class"]=e["class"]+(null!=d["class"]?" "+d["class"]:"")),b.props=d;if(b.props){var d=b.props,g;
for(g in d)!n.isEvProp(g)&&n.isFunc(d[g])&&("href"==g?(d.onclick=d[g],d.href=d[g].href):d[g]=d[g]()),n.isDynProp(b.tag,g)&&(d["."+g]=d[g]);if(n.isObj(d.style))for(var f in d.style)g=d.style[f],n.isFunc(g)&&(d.style[f]=g());n.isObj(d._hooks)&&(b.hooks=d._hooks,d._hooks=null);b.key=n.isVal(d._key)?d._key:n.isVal(d._ref)?d._ref:n.isVal(d.id)?d.id:n.isVal(d.name)?d.name:null;null!=d._ref&&(b.ref=d._ref);d._raw&&(b.raw=!0);null!=d._data&&(b.data=d._data);d._diff&&(b.diff=d._diff);d._ref=d._key=d._raw=
d._data=d._diff=null}}else n.isVal(d)?(b.type=n.TYPE_TEXT,b.body=d):n.isElem(d)&&(b.type=n.TYPE_ELEM,b.el=d,b.tag=d.nodeName.toLowerCase());null!==b.ref&&n.deepSet(c.refs,b.ref,b);b.parent=h;b.idx=m;b.ns=h&&h.ns?h.ns:"svg"===b.tag||"math"===b.tag?b.tag:null;a||b.diff||!n.isArr(b.body)||v(b,c);return b}function v(b,h){for(var m=0,c=b.body.length;m<c;m++){var a=b.body[m],d=null,e=null,k=!1,f=!1;n.isFunc(a)&&(a=a());if(null==a)k=!0;else{var p=n.isArr(a),v=p?!1:n.isObj(a);if(p)a.length?a._expl?f=!0:"string"==
typeof a[0]&&""!==a[0]?(e=g(a,b,m,h),d=e.key):n.isFunc(a[0])?d=w(a[1],a[2]):f=!0:k=!0;else if(v)if(n.isFunc(a.redraw))a.moveTo(b,m),e=a.node,d=a.view[1];else if(n.isElem(a))e=g(a,b,m,h);else{b.body[m--]=""+a;continue}else""===a?k=!0:0<m&&b.body[m-1].type===n.TYPE_TEXT?(b.body[m-1].body+=""+a,k=!0):e=g(""+a,b,m,h)}k||f?(f?n.insertArr(b.body,a,m,1):b.body.splice(m,1),c=b.body.length,m--):(null!==d&&(b.hasKeys=!0),b.body[m]=e||a)}b.body._init=!0}function y(b,h){if(C(h,b))return h.moved=!0,h.wasSame=
!0,h;h&&(f(b,"willRecycle",h,b),A(h,b),f(b,"didRecycle",h,b));if(n.isArr(b.body)){if(!b.body._init){for(var a=b;!a.vm;)a=a.parent;v(b,a.vm)}var c=0;b.body.forEach(function(a,d){var m=n.isArr(a);if(h){var e=B(a,b,h,c);if(null!==e){var k=e[0],e=e[1];k===c&&c++;k=h.body[k];k.vm?m?2===e?k.vm.moveTo(b,d,a[1]):1===e&&l(a[0],a[1],a[2],a[3],b,d):a.vm&&2===e&&a.vm===k.vm&&k.vm.moveTo(b,d):b.body[d]=y(a,k);return}}m?l(a[0],a[1],a[2],a[3],b,d):b.body[d]=y(a)})}return b}function q(b,h,a,c){for(var e=!b.el;a&&
a._node.removed;)a=a.nextSibling;e&&b.vm&&f(b.vm,"willMount",b.vm);if(b.type==n.TYPE_ELEM)if(e&&(b.el=h||(b.ns?K.createElementNS(P[b.ns],b.tag):K.createElement(b.tag)),b.props&&I(b)),n.isArr(b.body)){h=0;for(var d=b.el.firstChild;h<b.body.length;h++)d=q(b.body[h],null,d)}else n.isVal(b.body)&&(b.raw?b.el.innerHTML=b.body:e&&(b.el.textContent=b.body));else b.type==n.TYPE_TEXT&&e&&(b.el=K.createTextNode(b.body));b.el._node=b;h=b.parent;a!==b.el&&(c||h&&h.el)&&(h=e?"Insert":"Reinsert",f(b,"will"+h,b),
(c||b.parent.el).insertBefore(b.el,a),f(b,"did"+h,b));e&&b.vm&&b.vm.hooks&&!b.moved&&f(b.vm,"didMount",b.vm);return a!==b.el?a:a.nextSibling}function B(b,h,a,c,e){var d=n.isArr(b),k=d?w(b[1],b[2]):b.key,g=a.hasKeys,f=h.hasKeys;a=a.body;h=h.body;if(null!==k&&g)return b=n.keyedIdx(k,a,d?b[0]:null),-1<b?[b,2]:null;c=c||0;if(c>a.length-1)return null;e=0===e?0:e||a.length-1;for(k=null;c<=e;c++)if(g=a[c],null!==g&&g.el)if(d&&g.vm){if(g.vm.view[0]===b[0]){if(g.vm.view[1]===w(b[1],b[2]))return[c,2];!k&&f&&
-1==n.keyedIdx(g.key,h,g.vm.view[0])&&(k=[c,1])}}else if(b.type===g.type&&(b.type===n.TYPE_TEXT||null!==b.tag&&b.tag===g.tag)&&(null===g.key||!f||-1==n.keyedIdx(g.key,h,g.vm?g.vm.view[0]:null)))return[c,1];return k}function C(b,a){if(b&&b.diff&&a.diff&&b.diff[0]===a.diff[0]){var c=b.diff.slice(1).concat(a.diff.slice(1));return!a.diff[0].apply(null,c)}return!1}function A(b,a){if(b.el)if(a.el=b.el,b.el=null,a.el&&(a.el._node=a),a.type===n.TYPE_TEXT&&a.body!==b.body)a.el.nodeValue=a.body;else{I(a,b);
var c=!n.isArr(a.body),e=!n.isArr(b.body);c&&a.body!==b.body?e&&a.el.firstChild?a.el.firstChild.nodeValue=a.body:a.raw?a.el.innerHTML=a.body:a.el.textContent=a.body:e&&!c&&(a.el.textContent="");b.moved=!0}}function e(b){b.removed&&b.vm&&(b.vm.node=null);b.el=b.key=b.ref=b.data=b.diff=b.vm=b.body=b.props=null;b.raw=b.moved=b.wasSame=b.removed=!1;J.push(b)}function k(b,a,c,e){return function(c){var d,k=c.target._node,m=null;if(n.isFunc(b))d=b.call(a,c,k,e);else if(n.isArr(b))m=b.slice(1),d=b[0].apply(a,
