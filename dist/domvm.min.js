...
1),e=p;e;){if(e.events[a]){m.execAll(e.events[a],c);break}e=e.parent}},refs:{},parent:null,mount:function(a,c){p.hooks&&m.execAll(p.hooks.willMount);c&&(a.textContent="");h(p.node,c?a:null);c||a.insertBefore(p.node.el,null);p.hooks&&m.execAll(p.hooks.didMount);return p},attach:function(a){t(p.node,a);return p},unmount:function(){r(p.hooks,"Unmount",A,[])},moveTo:f,updIdx:function(a){y=a}};c&&c.hooks&&p.hook(c.hooks);p.render=a.call(p.exp,p,e,v,n);return b?f(b,y,n):q(0,n)}function t(a,e){a.el=e;if(m.isArr(a.body))for(var v=
0;v<a.body.length;v++)t(a.body[v],e.childNodes[v])}function d(a,e){m.isArr(a.body)&&(a.body.forEach(function(a,e){a&&(a.vm&&!a.moved?a.vm.unmount():d(a,!0))}),a.body=null);a.vm=null;e&&a.el&&a.el.parentNode&&r(a.hooks,"Remove",b,[a])}function b(a){a.el.parentNode.removeChild(a.el);a.el=null}function l(a,e,v,n){var c=a;a={type:null,key:null,ref:null,idx:null,parent:null,moved:!1,hooks:null,tag:null,ns:null,guard:!1,raw:!1,props:null,el:null,keyMap:null,body:null};m.isFunc(c)&&(c=c());if(m.isArr(c)&&
...
e:a.ns?E.createElementNS(K[a.ns],a.tag):E.createElement(a.tag),a.props&&A(a)),m.isArr(a.body)){e=0;for(var c=a.el.firstChild;e<a.body.length;e++)c=h(a.body[e],null,c)?c:c.nextSibling||null}else n&&m.isVal(a.body)&&(a.raw?a.el.innerHTML=a.body:a.el.textContent=a.body);else a.type==m.TYPE_TEXT&&n&&(a.el=E.createTextNode(a.body));a.el._node=a;if(b===a.el)return!1;if((e=a.parent)&&e.el)return r(a.hooks,n?"Insert":"Reinsert",f,[a,b]),!0}function f(a,e){a.parent.el.insertBefore(a.el,e)}function q(a,e,b,
...
k.type||a.type!==m.TYPE_TEXT&&(null===a.tag||a.tag!==k.tag)||null!==k.key&&f&&m.isVal(f[k.key])))return[n,1];return h}function D(a,e){e.el=a.el;a.el=null;if(e.type===m.TYPE_TEXT&&e.body!==a.body)e.el.nodeValue=e.body;else{A(e,a);var b=!m.isArr(e.body),d=!m.isArr(a.body);b&&e.body!==a.body?d&&e.el.firstChild?e.el.firstChild.nodeValue=e.body:e.raw?e.el.innerHTML=e.body:e.el.textContent=e.body:d&&!b&&(e.el.textContent="");a.moved=!0}}function r(a,e,b,d,c,h){if(a){var f=a["will"+e];m.isArr(f)&&(f=f[0]);
var k=a["did"+e];m.isArr(k)&&(k=k[0]);a=function(){b.apply(null,d);k&&k.apply(null,h||c||d)};f?(f=f.apply(null,c||d),m.isProm(f)?f.then(a):a()):a()}else b.apply(null,d)}function z(a){if(a in F)return F[a];var e={tag:null,id:null,"class":null};e.tag=a.replace(/^([\w\-]+)?(?:#([\w\-]+))?((?:\.[\w\-]+)+)?$/,function(a,b,c,d){c&&(e.id=c);d&&(e["class"]=d.replace(/\./g," ").trim());return b||"div"});return F[a]=e}function J(a,e,b,d){return function(c){var h;if(m.isFunc(a))h=a.call(e,c,b,d);else if(m.isObj(a))for(var f in a)c.target.matches(f)&&
(h=a[f].call(e,c,b,d));!1===h&&(c.preventDefault(),c.stopPropagation());d.opts.hasOwnProperty("watch")&&d.opts.watch.fire({vm:d})}}function A(a,e){var b=!e;e=e||{};if(e.props||a.props){var d=e.props||{},c=a.props||{},h=d.style,f=c.style;if(m.isObj(h)||m.isObj(f))H(a.el,h||{},f||{},x,G,a.ns,b),d.style=c.style=null;H(a.el,d,c,B,I,a.ns,b);f&&(c.style=f)}}function H(a,e,b,d,c,h,f){for(var k in b)null!==b[k]&&(k in e&&b[k]===e[k]||d(a,k,b[k],h,f));for(k in e)null!==e[k]&&(k in b||c(a,k,h,f))}function x(a,
e,b){a.style[e]=isNaN(b)||L[e]?b:b+"px"}function G(a,e){a.style[e]=""}function B(a,e,b,d,c){"."===e[0]?(e=e.substr(1),"svg"===d?a[e].baseVal=b:a[e]=b):"class"===e?a.className=b:"id"===e||m.isEvProp(e)?a[e]=b:!1===b?I(a,e,d,c):(!0===b&&(b=""),a.setAttribute(e,b))}function I(a,b,d,h){h||("."===b[0]?(b=b.substr(1),"svg"===d?a[b].baseVal=null:a[b]=null):"class"===b?a.className="":"id"===b||m.isEvProp(b)?a[b]=null:a.removeAttribute(b))}var K={svg:"http://www.w3.org/2000/svg",math:"http://www.w3.org/1998/Math/MathML"},
...
t){l=x;break}null===l&&(q.splice(f+1,1E4),q.push({name:b,route:u[b],params:d,path:t}),l=q.length-1);var x=q[f],G=q[l];Array.prototype.slice.call(arguments);var B=!0;null!==f&&(B=(B=q[f].route.onexit)?B.apply(null,[{to:G}].concat(x?x.params:[])):!0);!1!==B&&!1!==q[l].route.onenter.apply(null,[{from:x}].concat(d))&&(history[g?"replaceState":"pushState"]([b,d],"title",t),f=l);h=!1}},current:function(){return h?w(u,window.location.pathname):q[f]}},h=!0,f=null,q=[],u=b(g,l);d(u);window.onpopstate=function(b){g["goto"].apply(null,
