...
e:a.ns?E.createElementNS(K[a.ns],a.tag):E.createElement(a.tag),a.props&&A(a)),m.isArr(a.body)){e=0;for(var c=a.el.firstChild;e<a.body.length;e++)c=h(a.body[e],null,c)?c:c.nextSibling||null}else m.isVal(a.body)&&(a.raw?a.el.innerHTML=a.body:n&&(a.el.textContent=a.body));else a.type==m.TYPE_TEXT&&n&&(a.el=E.createTextNode(a.body));a.el._node=a;if(b===a.el)return!1;if((e=a.parent)&&e.el)return r(a.hooks,n?"Insert":"Reinsert",f,[a,b]),!0}function f(a,e){a.parent.el.insertBefore(a.el,e)}function q(a,e,
b,n,c){var d=m.isArr(a),h=d?a[2]||null:a.key,k=b.keyMap,f=e.keyMap;b=b.body;e=e.body;if(null!==h&&k&&m.isVal(k[h]))return[k[h],2];n=n||0;if(n>b.length-1)return null;c=0===c?0:c||b.length-1;for(h=null;n<=c;n++)if(k=b[n],null!==k&&k.el)if(d&&k.vm){if(k.vm.view[0]===a[0]){if(k.vm.view[1]===a[1])return[n,2];var g=!1;if(C.viewScan)for(var q=0;q<e.length;q++){var r=e[q];if(!r.el&&r.vm&&r.vm.view[0]===k.vm.view[0]&&r.vm.view[1]===k.vm.view[1]){g=!0;break}}g||h||!f||m.isVal(f[k.key])||(h=[n,1])}}else if(!(a.type!==
