...
(function() {
	...
	QUnit.todo("Fancy (delegated)", function(assert) {
		// todo: runs all matched delegs, not just first or most specific
	});

	QUnit.todo("Fancy (parameterized & delegated)", function(assert) {
